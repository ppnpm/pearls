...
- [Drug Regulation and Miscellaneous](#drug-regulation-and-miscellaneous) — 7 pearls
...
### 3. Dose–Response Curves: Potency, Efficacy and Antagonism
...
### 5. Inverse Agonists and Receptor Terminology
...
**UNDERSTAND:** Alpha-1 blockade increases lipoprotein lipase activity and insulin sensitivity, so triglyceride-rich particles are cleared faster. Conversely, beta-blockade removes the β-mediated stimulation of lipoprotein lipase (triglycerides rise, HDL falls) and thiazides induce insulin resistance, raising LDL and triglycerides. So the lipid effect follows directly from what each drug does to lipase and insulin sensitivity.
...
**EXAM CONNECTION:** A dyslipidaemic hypertensive is given; pick the drug that helps the lipids. Prazosin over thiazide/propranolol every time.
...
**UNDERSTAND:** Spironolactone is a steroidal MRA that concentrates in the kidney and generates canrenone and other active metabolites with long half-lives, so distal nephron sodium–potassium exchange is inhibited continuously and disproportionately in the kidney — maximising the potassium effect. Finerenone distributes evenly between heart and kidney and clears without persistent metabolites, so it delivers cardiorenal protection with less sustained renal potassium retention. Its non-steroidal structure also explains the absence of the endocrine side effects.
...
**UNDERSTAND:** Toxicity begins when iron exceeds the binding capacity of transferrin; the resulting non-transferrin-bound “free” iron catalyses Fenton free-radical reactions, causing lipid peroxidation, mitochondrial injury, increased capillary permeability and vasodilatation. Chelation is therefore aimed at the free fraction — which is why the threshold is a serum iron above the usual TIBC, and why chelation is useless once iron is safely bound intracellularly.
...
### 55. Tranexamic Acid and ε-Aminocaproic Acid
...
**UNDERSTAND:** Normally 95% of bile acids are reabsorbed in the terminal ileum and recycled. Sequestering them interrupts that enterohepatic circulation, so hepatic cholesterol is consumed making replacements; the falling intrahepatic cholesterol upregulates LDL receptors exactly as a statin does. But the same signal also upregulates HMG-CoA reductase, partly offsetting the effect — which is precisely why adding a statin is synergistic, and why the two are classically combined.
...
**UNDERSTAND:** It is a self-reinforcing loop. Absorbed calcium causes natriuresis and volume depletion, which drives bicarbonate reabsorption in the proximal tubule → alkalosis. Alkalosis in turn increases renal calcium reabsorption in the distal tubule, worsening the hypercalcaemia, while hypercalcaemia causes renal vasoconstriction and nephrogenic diabetes insipidus, worsening the volume depletion. Each element feeds the next — which is why it persists after the calcium is stopped unless the patient is rehydrated.
...
**UNDERSTAND:** Carbamazepine’s characteristic toxicities come from its 10,11-epoxide metabolite — the reactive intermediate responsible for the rash, the marrow suppression and the hepatic injury. Oxcarbazepine is the 10-keto analogue: it cannot form an epoxide, so those toxicities largely disappear. Its antidiuretic effect on the collecting duct is a property of the parent molecule, however, and is if anything stronger — hence the one adverse effect that goes the other way.
...
**UNDERSTAND:** Paroxetine’s risk is attributed to its exposure profile: it is the most potent, shortest-half-life, most anticholinergic SSRI, crosses the placenta readily, and its abrupt fluctuations are thought to disturb the first-trimester period of cardiac septation. Sertraline is favoured because it has the lowest milk transfer and the largest safety database.
...
**UNDERSTAND:** Every “side effect” of an antidepressant is simply a receptor being blocked somewhere it was doing useful work. Alpha-1 receptors maintain arteriolar tone, so blocking them drops the blood pressure — the same mechanism that makes prazosin an antihypertensive. The drug that raises blood pressure is venlafaxine at high dose, and that is by noradrenaline reuptake inhibition (more noradrenaline at the receptor), not by blocking anything.
...
**EXAM CONNECTION:** A four-way match with one deliberately inverted pair. Alpha-1 blockade lowers pressure — the “hypertension” option is always the false one.
...
**UNDERSTAND:** The extrapyramidal syndromes are not one entity. Acute dystonia and parkinsonism arise from nigrostriatal dopamine blockade with relative cholinergic excess — which is exactly why restoring the dopamine–acetylcholine balance with an anticholinergic works. Akathisia is thought to involve mesocortical dopamine and noradrenergic pathways instead, so the cholinergic manipulation is irrelevant and a lipophilic, CNS-penetrating beta-blocker is the effective drug.
...
**EXAM CONNECTION:** All four options treat *some* movement disorder — match the syndrome to the drug. Restlessness → propranolol; dystonia → anticholinergic; tardive → VMAT2 inhibitor.
...
**UNDERSTAND:** Serotonin stimulates hypothalamic ADH release and enhances its renal effect, so an SSRI produces a drug-induced SIADH. The elderly are uniquely vulnerable because ageing brings reduced renal free-water clearance, a lower total body water, increased ADH sensitivity and a blunted thirst/osmostat response — so the same drug effect produces a far larger fall in sodium. The timing (within the first 2–4 weeks) and the neurological presentation (falls, confusion, unsteadiness rather than “psychiatric” symptoms) are the recognisable pattern.
...
**EXAM CONNECTION:** The stem gives an elderly patient + a newly started antidepressant + hyponatraemia. Among the options, the SSRI is the culprit; bupropion, mirtazapine and selegiline are the low-risk distractors.
...
**PEARL:** Vilazodone is a spari — Serotonin PArtial agonist (5-HT1A) and Reuptake Inhibitor. It selectively blocks the serotonin transporter (no NE/DA effect) and is a 5-HT1A partial agonist.
...
**UNDERSTAND:** Every other local anaesthetic is a vasodilator, which is why adrenaline is added to them — to slow systemic absorption, prolong the block and reduce bleeding. Cocaine achieves this itself by preventing reuptake of noradrenaline at the sympathetic nerve terminal, so its own vasoconstriction is built in. The same mechanism is what makes it cardiotoxic and addictive.
...
**EXAM CONNECTION:** “Which statement is true about cocaine?” — the answer is the vasoconstriction; the false ones call it an amide or say it is weaker than lidocaine.
...
**UNDERSTAND:** Ethionamide is structurally a thionamide, like propylthiouracil and methimazole. It therefore does exactly what those antithyroid drugs do — inhibits thyroid peroxidase and the organification of iodine. The resulting fall in T4 releases TSH from feedback, and the raised TSH produces the goitre. The effect is a predictable, reversible pharmacological action rather than toxicity, which is why replacement (not withdrawal) is the answer.
...
- Antitubercular adverse-effect map: Isoniazid — peripheral neuropathy (pyridoxine deficiency), hepatitis, lupus-like syndrome, seizures in overdose (antidote pyridoxine). Rifampicin — orange discoloration of urine/tears/lenses, hepatitis, flu-like syndrome, potent CYP inducer (contraceptive failure, warfarin, ART interactions). Pyrazinamide — hyperuricaemia and arthralgia, hepatotoxicity (the most hepatotoxic first-line drug). Ethambutol — retrobulbar optic neuritis with loss of red–green colour vision; check visual acuity and colour vision at baseline. Streptomycin/amikacin — vestibulotoxicity and ototoxicity, nephrotoxicity; avoid in pregnancy (fetal VIII nerve damage). Cycloserine — psychosis, depression, suicidality, seizures. Linezolid — myelosuppression, optic and peripheral neuropathy. Bedaquiline — QT prolongation. PAS — GI intolerance and hypothyroidism.
...
**UNDERSTAND:** Tipranavir inhibits platelet aggregation (thromboxane A2 pathway) and inhibits vitamin K-dependent clotting, so it superimposes an acquired platelet defect on a pre-existing coagulation factor deficiency. In a haemophiliac — already unable to form a stable fibrin clot — the additional platelet dysfunction converts a trivial bleed into an intracranial catastrophe. Hence new headache, vomiting and altered consciousness in a haemophiliac on ART is a bleed until proven otherwise.
...
**EXAM CONNECTION:** The stem pairs a bleeding disorder with an antiretroviral — the drug is the one with the bleeding warning: tipranavir.
...
**UNDERSTAND:** Tumours survive by exploiting the physiological brakes that stop T cells attacking self. PD-1 on the T cell binds PD-L1 expressed by the tumour, switching the T cell off inside the tumour; CTLA-4 acts earlier, in the lymph node, outcompeting CD28 for B7. Blocking either restores a pre-existing anti-tumour response rather than killing cells directly — which explains both the delayed, sometimes durable responses and the fact that the side effects look like new-onset autoimmune disease in any organ.
...
- The other listed monoclonals are all correct statements in their own right — the question is which one matches the checkpoint class: Bevacizumab — anti-VEGF (anti-angiogenic): side effects hypertension, proteinuria, bleeding, impaired wound healing, GI perforation. Rituximab — anti-CD20: B-cell depletion for lymphoma, RA, ITP, pemphigus; reactivates hepatitis B — screen first, and causes PML rarely. Trastuzumab — anti-HER2 in breast and gastric cancer; cardiotoxicity (reversible, unlike anthracyclines) — monitor LVEF.
...
**UNDERSTAND:** Paracetamol is normally cleared by glucuronidation and sulfation; in overdose these saturate and the excess is shunted through CYP2E1 to NAPQI, a highly reactive electrophile that is detoxified by glutathione. Once glutathione stores fall below ~30%, NAPQI binds hepatocyte proteins and causes centrilobular (zone 3) necrosis — zone 3 because that is where CYP2E1 is concentrated and oxygen tension is lowest. NAC is simply a cysteine donor that regenerates glutathione, so it must arrive before the stores are exhausted.
...
**EXAM CONNECTION:** A “which statement is true” set — the true one is NAC’s safety in pregnancy; the false ones invert the toxicity (renal for hepatic), inflate the anaphylactoid rate, or claim oral superiority.
...
**UNDERSTAND:** Everything is explained by two mechanisms. Quinidine-like sodium-channel blockade slows cardiac conduction → QRS widening, right-axis deviation (terminal R in aVR), ventricular arrhythmia and hypotension. Muscarinic blockade gives the classic anticholinergic picture — and because sweating is cholinergic, the patient cannot thermoregulate and becomes HYPERthermic, never hypothermic.
...
- Porphyrinogenic drugs (“boost CHAP”): Barbiturates, Oral contraceptives, Orphenadrine, Sulphonamides, Tetracyclines, Chloramphenicol/Carbamazepine, Halothane/Hydralazine, Alcohol, Phenytoin. Also griseofulvin, rifampicin, oestrogens and fasting/low-calorie diets.
