...
## Physics, Radiation Biology and Radiotherapy
...
**PEARL:** The three sub-syndromes appear in a **strict DOSE order: HAEMATOPOIETIC (bone marrow) at the LOWEST dose (>1 Gy) → GASTROINTESTINAL (6–10 Gy) → NEUROVASCULAR/CNS at the highest (>20–30 Gy)**. The bone marrow is affected **first and at the lowest dose** — so the statement that GI effects occur at a lower dose than marrow depression is **false**.

**UNDERSTAND:** Radiosensitivity follows the **law of Bergonié and Tribondeau**: tissues are most sensitive when their cells are **rapidly dividing, undifferentiated and metabolically active**. **Haematopoietic stem cells divide constantly**, so they die at the lowest doses; **intestinal crypt cells** divide almost as fast, so they follow; **neurons do not divide at all**, so CNS damage requires doses high enough to destroy the vasculature directly. The same principle predicts which normal tissues limit radiotherapy dose.
...
**EXAM CONNECTION:** "Which statement is FALSE?" — the false option inverts the **dose hierarchy**. Fix the order: **marrow lowest, then gut, then brain.**

**REMEMBER:** *The faster a tissue divides, the sooner radiation kills it — marrow first, neurons last.*
...
**PEARL:** **The S phase (especially late S) is the MOST RADIORESISTANT** phase of the cell cycle; **M (mitosis) and late G2 are the MOST RADIOSENSITIVE**. G1 is intermediate.

**UNDERSTAND:** Radiosensitivity tracks the cell's **capacity to repair a double-strand break at that moment**. In **late S phase the DNA has been replicated, so a SISTER CHROMATID is available as a template for error-free HOMOLOGOUS RECOMBINATION** — the cell can fix almost anything. In **mitosis the chromatin is maximally condensed, repair enzymes cannot access it, and there is no time before division** — so damage is carried straight into daughter cells as lethal aberrations. G2 lacks the time buffer of G1. Radiosensitivity is therefore a story about **template availability and repair time**.
...
**EXAM CONNECTION:** A single-phase recall question. **S = resistant, M = sensitive** — and the mechanism (sister chromatid template) is the reason.
...
## Contrast Media and Imaging Techniques

### 8. Contrast Media and PET-CT
...
**PEARL:** **ULTRASOUND contrast agents (sulphur hexafluoride microbubbles — SonoVue) are the only contrast agents SAFE in renal failure** — they are **exhaled through the LUNGS and have no renal excretion at all**. Iodinated (CT) contrast risks **contrast-induced nephropathy**, and gadolinium (MRI) risks **nephrogenic systemic fibrosis**.

**UNDERSTAND:** Nephrotoxicity is a problem of **renal clearance and renal exposure**. Iodinated and gadolinium agents are both **small, water-soluble molecules cleared almost entirely by glomerular filtration**, so in renal failure they are retained, concentrated in tubules and (for gadolinium) dissociate to release free Gd³⁺, which deposits in tissue. Microbubbles are **blood-pool agents that never leave the vascular compartment and are eliminated as gas via respiration** — the kidney is bypassed entirely, which is why they have no nephrotoxicity and need no renal function testing.
...
### 11. Chest Radiology — Air, Cavities and Nodules
...
### 13. Chest Imaging in the Immunocompromised and in Occupational Disease
...
### 15. Assessing a Normal Chest Radiograph
...
**PEARL:** **Bochdalek hernia is a POSTERIOR mediastinal mass** (posterolateral diaphragmatic defect, usually left). **Thymoma** is **anterior**, and the **tortuous innominate artery and enlarged pulmonary artery** are **middle** mediastinal.

**UNDERSTAND:** The compartments are just anatomical containers, so what can appear in each is entirely predictable from what normally lives there. **Anterior** holds the thymus, lymph nodes, retrosternal thyroid extension and germ cells; **middle** holds the heart, great vessels, trachea, main bronchi and nodes; **posterior** holds the sympathetic chain, nerve roots, oesophagus, descending aorta and the diaphragmatic hiatuses — which is why **neurogenic tumours and diaphragmatic hernias are posterior**.
...
### 20. Congenital Heart Disease on the Chest Film
...
### 23. Diaphragmatic Hernias and the Cardiophrenic Angle
...
### 24. Aortic Dissection on CT — True vs False Lumen
...
**UNDERSTAND:** The imaging appearance is a direct picture of the parasite's anatomy. The cyst has an outer host-derived **pericyst**, a middle acellular **laminated membrane** (the lamellar wall that calcifies) and an inner **germinal layer** that buds off **daughter cysts and brood capsules**. Nothing else in the liver reproduces that layered, compartmented structure — which is why a cyst-within-a-cyst is essentially diagnostic.
...
**EXAM CONNECTION:** CT image → the **calcified lamellar wall and daughter cysts** are pathognomonic. The **water-lily sign** is the other classic image.
...
**UNDERSTAND:** IVU images **function, not anatomy** — the nephrogram and pyelogram appear only if enough functioning nephrons filter and concentrate the iodinated contrast. A hypoplastic kidney has too few nephrons to generate a visible density. Obstruction, by contrast, typically gives a **delayed, dense, persistent nephrogram** (contrast is filtered but cannot drain), and duplication gives **extra**, not absent, collecting systems. So "absent" points to absent parenchyma, "delayed and dense" points to obstruction.
...
**UNDERSTAND:** A ureterocele is a **cystic dilatation of the intravesical submucosal ureter** caused by a stenotic orifice. On urography, contrast fills the dilated segment (the "head") while the **thin surrounding bladder mucosa and ureterocele wall appear as a lucent halo** — exactly the profile of a cobra's hooded head. The imaging sign is therefore a direct picture of the anatomy.
...
**EXAM CONNECTION:** Sign-to-diagnosis matching. **Cobra head = ureterocele; flower vase = horseshoe kidney; drooping lily = duplex system.**
...
**UNDERSTAND:** **Enhancement is the single most important CT criterion** — it proves the lesion has a blood supply and is therefore solid tissue rather than fluid. RCC is **hypervascular**, which is also why it presents with haematuria, bleeds, and forms **tumour thrombus in the renal vein and IVC**. Angiomyolipoma is excluded by finding **macroscopic fat (NEGATIVE Hounsfield units, −20 HU or lower)** — the only reliably benign CT feature of a solid renal mass.
...
**EXAM CONNECTION:** The CT description is the question. **Heterogeneous + enhancing = RCC; fat = AML; central scar + homogeneous = oncocytoma; water density, no enhancement = cyst.**
...
**UNDERSTAND:** The arterial triphasic waveform exists because a **high-resistance vascular bed** reflects the pulse wave: forward systolic flow → brief **reverse** flow in early diastole (elastic recoil against high peripheral resistance) → small late forward flow. **Distal ischaemia causes vasodilatation, which lowers resistance and abolishes the reverse flow** — so the waveform "flattens" progressively as disease worsens. Veins have no pulsatile pump and low resistance, so they are monophasic from the start.
...
**EXAM CONNECTION:** Waveform or M-mode image identification. **Monophasic vein = normal; monophasic artery = disease; sandy beach = normal lung.**

**REMEMBER:** *Veins flow steadily, arteries bounce three times, and healthy lung looks like a beach.*
...
**UNDERSTAND:** The pan-scan is designed to find **injuries that will kill in the next hour and that clinical examination cannot exclude** — intracranial haemorrhage, unstable cervical spine injury, aortic injury, haemothorax and intra-abdominal bleeding. Limb injuries are **visible, palpable and rarely immediately lethal**, so scanning them adds radiation and time without changing the resuscitation. The head and neck are non-contrast because **acute blood is already hyperdense** and contrast would obscure it; the torso is contrast-enhanced because that is what reveals **active extravasation and solid-organ laceration**.
...
**EXAM CONNECTION:** "All are included EXCEPT" — the exclusion is always the **limbs**. The FAST image question turns on recognising **anechoic fluid in Morison's pouch = positive**.
