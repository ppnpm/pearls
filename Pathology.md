...
- [General Pathology — Cell Injury, Adaptation, Necrosis and Apoptosis](#general-pathology--cell-injury-adaptation-necrosis-and-apoptosis) — 6 pearls
- [Neoplasia, Carcinogenesis and Molecular Techniques](#neoplasia-carcinogenesis-and-molecular-techniques) — 5 pearls
- [Immunopathology and Immunodeficiency](#immunopathology-and-immunodeficiency) — 5 pearls
- [Haematology](#haematology) — 15 pearls
- [Coagulation and Transfusion Medicine](#coagulation-and-transfusion-medicine) — 4 pearls
- [Cardiovascular Pathology](#cardiovascular-pathology) — 6 pearls
- [Respiratory Pathology](#respiratory-pathology) — 3 pearls
- [Renal Pathology](#renal-pathology) — 4 pearls
- [Hepatobiliary Pathology](#hepatobiliary-pathology) — 13 pearls
- [Gastrointestinal Pathology](#gastrointestinal-pathology) — 19 pearls
- [Endocrine Pathology](#endocrine-pathology) — 5 pearls
- [Breast and Female Genital Tract](#breast-and-female-genital-tract) — 3 pearls
- [Male Genital Tract](#male-genital-tract) — 2 pearls
- [Skin, Bone, Soft Tissue and Neuropathology](#skin-bone-soft-tissue-and-neuropathology) — 5 pearls
- [Miscellaneous](#miscellaneous) — 2 pearls

---

## General Pathology — Cell Injury, Adaptation, Necrosis and Apoptosis

### 1. Named Inclusion Bodies and Structures

**PEARL:** **PSAMMOMA BODIES (concentric lamellated calcifications) → MENINGIOMA, PAPILLARY THYROID carcinoma, papillary renal cell carcinoma, SEROUS PAPILLARY carcinoma of the ovary and mesothelioma.** **Russell bodies → multiple myeloma. Verocay bodies → schwannoma. Call–Exner bodies → granulosa cell tumour.**

**UNDERSTAND:** Psammoma bodies form by **dystrophic calcification within areas of infarcted or apoptotic tumour cells at the tips of papillae** — which is why they cluster in tumours with a **papillary architecture and a sluggish blood supply**. They are a **read-out of tumour architecture, not of a specific tissue**, which is exactly why one finding spans meninges, thyroid, kidney and ovary. Recognising the *reason* prevents the usual rote-list confusion.
...
**PEARL:** **CASPASE 9 initiates the INTRINSIC (mitochondrial) pathway and CASPASE 8 the EXTRINSIC (death receptor) pathway**; both converge on the **EXECUTIONER caspases 3 and 6**. **COUNCILMAN (acidophil) BODIES in viral hepatitis are apoptotic hepatocytes.**

**UNDERSTAND:** Apoptosis is built as a **two-tier proteolytic cascade** for a reason: initiator caspases are activated by **clustering on a scaffold** (the apoptosome for caspase 9, the DISC for caspase 8), which requires a genuine, sustained signal — this prevents accidental cell suicide. Once activated, they cleave the executioner caspases, giving **rapid, irreversible amplification** that dismantles the cell in minutes. Knowing which caspase is the initiator therefore tells you **which pathway was triggered**.
...
### 5. Cellular Adaptations — Anaplasia, Hyperplasia, Metaplasia
...
### 6. Hypertrophy and Hyperplasia Together — The Pregnant Uterus
...
## Neoplasia, Carcinogenesis and Molecular Techniques

### 7. Carcinoma of Unknown Primary
...
**PEARL:** **Double-strand break repair** uses **ATM, BRCA1/BRCA2 (homologous recombination)** and **Ku70/Ku80 with DNA-PK (non-homologous end joining)**. **MSH2 belongs to MISMATCH repair**, not double-strand break repair.

**UNDERSTAND:** Each repair system is named for the **kind of damage it fixes**, and the proteins are not interchangeable. A **mismatch** is a single wrongly paired base left by polymerase — repaired by proofreading proteins that scan the new strand (**MSH2/MSH6 detect, MLH1/PMS2 excise**). A **double-strand break** severs the backbone of both strands — a lesion that risks translocation or cell death, so it needs either a **sister-chromatid template (homologous recombination, error-free, S/G2 phase)** or a **blunt re-ligation (NHEJ, error-prone, any phase; dominant in mammals)**.
...
### 10. Occupational and Environmental Carcinogens
...
### 21. Prognostic Genetics in Multiple Myeloma
...
### 22. Waldenström Macroglobulinaemia

**PEARL:** Elderly patient + **hyperviscosity** (visual disturbance, headache, epistaxis, neuropathy) + **rouleaux formation** + **Dutcher bodies** (intranuclear PAS-positive inclusions) + **positive Coombs test** = **Waldenström macroglobulinaemia** — an **IgM-secreting lymphoplasmacytic lymphoma** with the **MYD88 L265P** mutation.

**UNDERSTAND:** Every feature follows from the physical properties of **IgM**. It is a **pentamer**, enormous and largely intravascular, so even modest amounts raise serum viscosity dramatically → sludging in retinal and cerebral vessels, mucosal bleeding, and demyelinating neuropathy (anti-MAG antibodies). Because it is too big to leave the circulation, it does **not** deposit in tubules or activate osteoclasts — which is why, unlike myeloma, there are **no lytic bone lesions and renal failure is uncommon**. IgM also acts as a **cold agglutinin**, giving rouleaux and a positive Coombs test.
...
**EXAM CONNECTION:** The discriminator against myeloma is always the same pair — **IgM + hyperviscosity + organomegaly, with NO lytic bone lesions**. Dutcher bodies and MYD88 are the modern high-yield add-ons.
...
### 23. Hereditary Spherocytosis and Pigment Gallstones

**PEARL:** A young patient with a **haemolytic anaemia and spherocytes on the smell** — spherocytes on the smear — develops **PIGMENT (black) gallstones**, and may present with biliary colic or an acute abdomen from a **haemolytic crisis**.

**UNDERSTAND:** Chronic haemolysis floods the liver with **unconjugated bilirubin**, which is excreted into bile as **calcium bilirubinate**. When the bile becomes supersaturated with it, **black pigment stones** precipitate. So gallstones in a child or young adult are not a coincidence — they are the expected consequence of any lifelong haemolytic state, which is why the exam pairs a peripheral smear with an abdominal presentation.
...
**EXAM CONNECTION:** The smear is the whole question — spherocytes with no clue of autoimmunity → **hereditary spherocytosis → pigment gallstones**.
...
### 25. Paroxysmal Nocturnal Haemoglobinuria
...
### 26. Reading a Peripheral Smear — Leukaemias and Lymphomas
...
### 27. Multiple Myeloma — Plasma Cell Inclusions
...
### 28. Cutaneous T-Cell Lymphoma — Sézary vs Mycosis Fungoides
...
### 29. ATRA and Acute Promyelocytic Leukaemia
...
### 30. ALL — Immunophenotype and Age
...
### 31. Folate Deficiency in Chronic Alcoholics
...
### 32. Inherited Platelet Function Disorders
...
### 33. Blood Products — Storage and Anticoagulants
...
### 35. Bleeding Time and the Platelet Disorders
...
### 37. Cardiac Tumours and Carney Complex
...
### 38. Thromboangiitis Obliterans (Buerger Disease)
...
### 39. Aortic Dissection — DeBakey and Stanford
...
### 40. Blood Cultures in Infective Endocarditis
...
### 44. Emphysema — Matching Pattern to Cause
...
### 46. Post-Streptococcal Glomerulonephritis and RPGN
...
### 47. Glomerular Deposits on Electron Microscopy
...
### 49. Zonal Patterns of Liver Injury
...
### 51. Liver Function Tests — What Each One Measures
...
### 52. Portal Hypertension — Where the Block Is
...
### 53. Alcoholic Liver Disease — the Histological Sequence
...
### 54. Drug-Induced Liver Injury — Signature Histologies
...
### 56. Wilson Disease and Haemochromatosis — Diagnosis and Deposits
...
### 58. Cholangiocarcinoma and Hepatoblastoma
...
### 60. Hepatitis — Acute vs Chronic Histology
...
### 61. Dysplastic Nodules and Hepatocellular Carcinoma
...
### 65. Systemic Sclerosis and the Gut
...
### 66. Chronic Gastritis and *Helicobacter pylori*
...
### 67. Gastric Adenocarcinoma — Diffuse versus Intestinal
...
### 68. Hypertrophic Pyloric Stenosis and Upper GI Bleeding Lesions
...
### 69. Mechanisms of Malabsorption
...
### 70. Congenital Diarrhoeas — IPEX and Microvillus Inclusion Disease
...
### 71. Paediatric Structural Gut Disease — Meckel, Intussusception, Hirschsprung
...
### 72. Colitis, Ischaemia and Infectious Sequelae
...
### 73. Gastrointestinal Carcinoids by Site
...
### 74. *Clostridioides difficile* Colitis
...
### 75. Crohn Disease versus Ulcerative Colitis
...
### 76. Colorectal Carcinoma and Lynch Syndrome
...
### 77. Polyps and Appendiceal Tumours
...
### 78. Hirschsprung Disease — Which Layers
...
### 79. Oesophageal Carcinoma — Recognising the Type
...
### 80. Colorectal Carcinoma — Adenoma–Carcinoma Sequence
...
### 83. Somatotroph Adenoma and PIT-1
...
### 84. Hashimoto Thyroiditis — Histology
...
### 86. Phyllodes Tumour vs Fibroadenoma
...
### 87. Breast Cancer — HER2 Testing and Molecular Subtypes
...
### 88. Sarcoma Botryoides and Molluscum Contagiosum
...
### 89. Leydig Cell Tumour and Reinke Crystalloids

**PEARL:** **Rod-shaped Reinke crystalloids** in the cytoplasm of large polygonal cells with abundant eosinophilic cytoplasm = **LEYDIG CELL TUMOUR** — the commonest **sex cord–stromal** tumour of the testis, usually **benign, unilateral, and hormonally active**.

**UNDERSTAND:** Reinke crystalloids are found in **normal Leydig cells** too, so the tumour simply retains a differentiated feature of its cell of origin — which is why they are pathognomonic. The same differentiation explains the endocrine presentation: Leydig cells exist to make **androgens (and aromatise them to oestrogens)**, so a tumour of them causes **gynaecomastia in adults and precocious puberty in boys**.
...
### 90. Immunohistochemistry of Seminoma
...
## Skin, Bone, Soft Tissue and Neuropathology
...
### 95. Basal Cell Carcinoma and Patterns of Spread
...
### 96. Gallstones and Cardiac Rhabdomyoma — Two Classic Morphology Calls
...
### 97. Turner Syndrome — Essential Workup
