...
- [Physiology and Anatomy of Pregnancy](#physiology-and-anatomy-of-pregnancy) — 10 pearls
- [Antenatal Care, Screening and Prenatal Diagnosis](#antenatal-care-screening-and-prenatal-diagnosis) — 12 pearls
- [Early Pregnancy — Abortion, Ectopic and Trophoblastic Disease](#early-pregnancy--abortion-ectopic-and-trophoblastic-disease) — 6 pearls
- [Hypertensive Disorders of Pregnancy](#hypertensive-disorders-of-pregnancy) — 6 pearls
- [Medical and Surgical Disorders in Pregnancy](#medical-and-surgical-disorders-in-pregnancy) — 10 pearls
- [Infections in Pregnancy](#infections-in-pregnancy) — 4 pearls
- [Antepartum Haemorrhage and Placental Disorders](#antepartum-haemorrhage-and-placental-disorders) — 3 pearls
- [Multiple Pregnancy](#multiple-pregnancy) — 3 pearls
- [Fetal Surveillance and Fetal Disorders](#fetal-surveillance-and-fetal-disorders) — 5 pearls
- [Labour — Normal and Abnormal](#labour--normal-and-abnormal) — 18 pearls
- [Operative Obstetrics](#operative-obstetrics) — 5 pearls
- [Puerperium, Postpartum Complications and Lactation](#puerperium-postpartum-complications-and-lactation) — 8 pearls

**GYNAECOLOGY**

- [Gynaecological Anatomy](#gynaecological-anatomy) — 4 pearls
- [Reproductive Physiology, Puberty and Menopause](#reproductive-physiology-puberty-and-menopause) — 4 pearls
- [Menstrual Disorders and Abnormal Uterine Bleeding](#menstrual-disorders-and-abnormal-uterine-bleeding) — 6 pearls
- [Benign Gynaecological Conditions](#benign-gynaecological-conditions) — 6 pearls
- [Gynaecological Oncology](#gynaecological-oncology) — 15 pearls
- [Infertility and Assisted Reproduction](#infertility-and-assisted-reproduction) — 6 pearls
- [Genital Tract Infections](#genital-tract-infections) — 2 pearls
- [Urogynaecology and Pelvic Floor](#urogynaecology-and-pelvic-floor) — 5 pearls
- [Contraception and Sterilisation](#contraception-and-sterilisation) — 8 pearls
- [Disorders of Sex Development and Müllerian Anomalies](#disorders-of-sex-development-and-müllerian-anomalies) — 4 pearls
- [Gynaecological Procedures and Instruments](#gynaecological-procedures-and-instruments) — 3 pearls
- [Medicolegal, Public Health and Miscellaneous](#medicolegal-public-health-and-miscellaneous) — 3 pearls
...
### 1. Cardiovascular Changes of Pregnancy

**PEARL: **Physiological in pregnancy:** 15° LEFT AXIS DEVIATION, small Q and inverted T in lead III, mild inferior ST changes, atrial/ventricular premature contractions, a loud widely split S1, an S3, a SOFT SYSTOLIC EJECTION (flow) murmur, a venous hum, a MAMMARY SOUFFLÉ, and an apex beat displaced UP AND LEFT.** **A PANSYSTOLIC MURMUR, ANY DIASTOLIC MURMUR, OR BRADYCARDIA IS NEVER PHYSIOLOGICAL.**

**UNDERSTAND:** Pregnancy is a **high-output, low-resistance** state (plasma volume +50%, cardiac output +30–50%, SVR down) superimposed on a **diaphragm elevated ~4 cm** by the gravid uterus. High flow across normal valves plus low viscosity gives a **systolic ejection murmur**; the raised diaphragm rotates the heart, giving left axis deviation and inferior ST-T changes. **No amount of flow creates a pansystolic or diastolic murmur** — those need a structurally abnormal valve or a shunt.
...
**PEARL:** The **~50% rise in plasma volume** is driven by **OESTROGEN (directly and via the renin–angiotensin–aldosterone system) and ALDOSTERONE**, acting through **renal sodium and water retention**. **ADH LEVELS ARE UNCHANGED** — only the osmotic threshold is reset downward.

**UNDERSTAND:** Pregnancy resets the set-point rather than switching on a new hormone. Progesterone/oestrogen **vasodilatation** is read by the kidney as **underfilling** → RAAS activation → aldosterone retains salt and water until the enlarged vascular space is refilled. The **osmostat resets ~10 mOsm/kg lower**, so a sodium of ~135 is normal and ADH secretion continues appropriately at that lower osmolality — hence **normal, not raised, ADH**.
...
**EXAM CONNECTION:** Reject any option naming **ADH** as the driver of volume expansion.
...
**PEARL:** **Functional residual capacity FALLS** (with expiratory reserve volume, residual volume and total lung capacity). **Tidal volume, inspiratory capacity and minute ventilation RISE.** **Respiratory rate and vital capacity are UNCHANGED.**

**UNDERSTAND:** Two opposing forces. The **enlarging uterus elevates the diaphragm ~4 cm**, mechanically lowering resting end-expiratory volume → low FRC. Meanwhile **progesterone directly stimulates the respiratory centre**, raising **tidal volume, not rate**. Minute ventilation therefore rises purely by depth, giving a **compensated respiratory alkalosis** that favours placental CO₂ transfer. Chest circumference increases and the subcostal angle widens, so **vital capacity is preserved**.

**MUST KNOW:**

- **Minute ventilation rises ~40%**, driven by tidal volume; **respiratory rate essentially unchanged** — frequently tested.
- Blood gases: **PaCO₂ ~28–32 mmHg**, **PaO₂ ~104–108**, **bicarbonate ~18–21 mEq/L**, pH **7.40–7.45**.
- **Reduced FRC + increased oxygen consumption = rapid desaturation on apnoea** — hence **pre-oxygenation is critical** and rapid sequence induction is standard.
...
### 4. Glucose and Insulin Physiology in Pregnancy
...
- **The corpus luteum survives ~14 days unless rescued by hCG — hence the LUTEAL PHASE IS FIXED (14 days) while the FOLLICULAR PHASE VARIES**, and ovulation is dated backwards from the next period.
- **LUTEAL–PLACENTAL SHIFT at 7–9 weeks**: before it progesterone is from the corpus luteum (ovariectomy before 7 weeks → miscarriage); after it, from the placenta.
- **Oestradiol peaks 24–36 h BEFORE the LH surge and triggers it by POSITIVE feedback; ovulation ~34–36 h after the surge begins, ~10–12 h after the LH peak.**
- **Functionalis** = spiral arteries, shed monthly; **basalis** = basal/straight arteries, retained and regenerative. Menstruation = progesterone withdrawal → spiral artery vasoconstriction → ischaemic shedding.
- **Secretory biopsy confirms ovulation; a persistently PROLIFERATIVE endometrium with amenorrhoea/AUB means ANOVULATION** (unopposed oestrogen → hyperplasia → carcinoma, as in PCOS and perimenopause).
- Progesterone also raises **basal body temperature 0.3–0.5 °C** and thickens cervical mucus (losing **ferning and spinnbarkeit**).
...
- **Uterine blood flow at term ~500–750 mL/min = 10–15% of maternal cardiac output, and is NOT AUTOREGULATED** — it varies directly with maternal perfusion pressure, so **maternal hypotension is immediately fetal hypoxia**. This underlies aortocaval compression, careful spinal management, and not over-treating BP in pre-eclampsia.
- **Failure of the SECOND WAVE of trophoblastic invasion (16–20 weeks)** leaves spiral arteries narrow and responsive — the primary lesion of **PRE-ECLAMPSIA and FGR**.
- **Placental transfer — SIMPLE DIFFUSION:** O₂, CO₂, water, most electrolytes, lipid-soluble drugs. **FACILITATED:** glucose. **ACTIVE:** amino acids, calcium, iron, water-soluble vitamins. **PINOCYTOSIS:** IgG (the only immunoglobulin that crosses). **DO NOT CROSS: insulin, heparin, IgM.**
- Placenta at term **~500 g**; fetal:placental weight ratio **~6:1**.
...
### 7. Fetal and Placental Haemodynamics
...
- **The umbilical VEIN carries OXYGENATED blood TO the fetus; the two ARTERIES carry deoxygenated blood away** — the reverse of the systemic circulation. **A SINGLE UMBILICAL ARTERY** associates with renal and cardiac anomalies and aneuploidy.
- **Fetal shunts direct the best-oxygenated blood to brain and heart: DUCTUS VENOSUS (umbilical vein → IVC, bypassing liver) → FORAMEN OVALE (RA → LA) → ascending aorta; the DUCTUS ARTERIOSUS diverts RV output away from the lungs.**
- **In a contraction, intervillous pressure exceeds spiral artery pressure so INFLOW CEASES — exchange happens BETWEEN contractions.** Hence **tachysystole causes fetal hypoxia** and oxytocin is titrated to **≤5 contractions per 10 minutes**.
- **FUNIC (fetal) SOUFFLÉ:** soft blowing murmur **synchronous with the FETAL heart**, from rushing blood in the **umbilical arteries**. **UTERINE SOUFFLÉ:** soft systolic murmur low at the sides of the uterus, **synchronous with the MATERNAL pulse**, from dilated uterine vessels — also heard over a large **fibroid**.
- **Umbilical artery Doppler measures downstream PLACENTAL resistance:** rising S/D ratio → **absent** → **REVERSED** end-diastolic flow, in order of worsening severity.
...
### 8. Embryonic and Fetal Development Milestones
...
- **Lung maturity:** canalicular phase 16–26 weeks; surfactant from type II pneumocytes rises from ~24 weeks, adequate by **34–36 weeks**.
...
### 10. Innervation of the Uterus and Labour Pain

**PEARL:** **Sensory fibres from uterus and cervix run with the sympathetics to T10–L1**, so **FIRST-STAGE pain is referred to T10–L1** (lower abdomen, back); **SECOND-STAGE pain (perineal distension) travels in the PUDENDAL NERVE, S2–S4**. **UTERINE CONTRACTILITY IS NOT NEURALLY DRIVEN — it is hormonal and myogenic** (oestrogen, prostaglandins, oxytocin; progesterone maintains quiescence).

**UNDERSTAND: **The proof is clinical:** a woman with complete cord transection above T10 still labours and delivers**, feeling nothing. The uterus has a fundal myometrial pacemaker with gap-junction (connexin-43) coupling that increases at term. Hence **regional anaesthesia abolishes the PAIN without abolishing LABOUR**.
...
- **Routine prophylaxis: 300 µg (1500 IU) IM at 28 WEEKS (± 34 weeks) and 300 µg WITHIN 72 HOURS of delivering an Rh-positive infant.** If missed, still worth giving up to **10–13 days**.
- **Dose by gestation: 50 µg (250 IU) before 12 weeks; 300 µg thereafter. One 300 µg dose covers ~30 mL fetal WHOLE blood (15 mL red cells).**
- **Other indications: abortion (spontaneous or induced, any gestation), ectopic, molar pregnancy, fetal death, amniocentesis/CVS/cordocentesis, external cephalic version, antepartum haemorrhage, abdominal trauma, MANUAL REMOVAL OF PLACENTA.**
- **KLEIHAUER–BETKE TEST** (or flow cytometry) quantifies **fetomaternal haemorrhage** and decides whether extra doses are needed — essential after abruption, trauma, manual removal or twin delivery. It exploits the **resistance of fetal haemoglobin to acid elution**.
- **A weakly positive DCT can simply reflect ANTENATAL anti-D given at 28 weeks** (passive antibody) — this is **not** sensitisation, and postnatal anti-D should still be given.
- **Monitoring the ALREADY-sensitised pregnancy:** maternal antibody **titre (critical 1:16–1:32)**, then **MCA PEAK SYSTOLIC VELOCITY >1.5 MoM** → cordocentesis and **intrauterine transfusion**. MCA Doppler has replaced serial amniocentesis (Liley/Queenan curves).
...
**PEARL:** **NUCHAL TRANSLUCENCY is measured at 11+0 to 13+6 WEEKS (CRL 45–84 mm).** **Combined first-trimester screening = NT + free β-hCG + PAPP-A + maternal age.** In **DOWN SYNDROME: NT↑, β-hCG HIGH, PAPP-A LOW; in TRISOMY 18 and 13, ALL markers are LOW.**

**UNDERSTAND:** The window is fixed by biology — **before 11 weeks the fetus is too small to measure, and after 14 weeks the fetal lymphatics mature and drain the nuchal fluid away**, so the marker disappears.
...
**PEARL:** An increased **NT (≥3.5 mm, above the 99th centile)** with a **NORMAL karyotype** still demands a **detailed FETAL ECHOCARDIOGRAM in the second trimester** — the residual risk is **CONGENITAL HEART DISEASE**.

**UNDERSTAND:** Nuchal fluid accumulates whenever lymphatic return from the head and neck is impaired or **central venous pressure is raised**. Aneuploidy is only one cause. A structurally abnormal heart or great vessels produces exactly the same finding — so excluding aneuploidy removes one explanation, not the finding itself.
...
### 14. Second-Trimester Quadruple Screen
...
### 16. Non-Invasive Prenatal Testing (NIPT)

**PEARL:** **NIPT is a SCREENING test, not a diagnostic test.** A positive result must be confirmed by **CVS or amniocentesis**.

**UNDERSTAND:** NIPT measures **cell-free DNA in maternal plasma derived from the PLACENTA (apoptotic trophoblast), not from the fetus**. Because of **confined placental mosaicism, a vanishing twin, and maternal mosaicism or malignancy**, the placental genotype can differ from the fetal one — so however high the detection rate, it can never be diagnostic.
...
**PEARL:** **CVS is performed at 11–13 weeks** (transcervical 10–13 weeks; transabdominal from 10 weeks onward). **NEVER before 10 weeks** — risk of **LIMB-REDUCTION and oromandibular defects**.

**UNDERSTAND:** Before 10 weeks the **limb buds and mandible are still forming**, and villus sampling causes **vascular disruption** in a critically vascular period. After 10 weeks their organogenesis is complete, so the same procedure is safe.
...
**EXAM CONNECTION:** Number recall — the distractors are all **earlier** than 10 weeks.
...
**PEARL:** **HIGH-DOSE (4–5 mg/day) folic acid** is indicated for: **a PREVIOUS CHILD WITH A NEURAL TUBE DEFECT or family history, PRE-GESTATIONAL/POORLY CONTROLLED DIABETES, OBESITY (BMI >30), ANTIEPILEPTICS (valproate, carbamazepine, phenytoin), other FOLATE ANTAGONISTS (methotrexate, trimethoprim, sulfasalazine), HAEMOGLOBINOPATHIES with chronic haemolysis, and MALABSORPTION.** Everyone else takes **400–500 µg**. **Start at least 1–3 months BEFORE conception and continue to 12–16 weeks.**

**UNDERSTAND: **The timing is embryological:** the neural tube closes by day 28 post-conception, often before the woman knows she is pregnant** — folate started after a positive test is too late for its primary purpose. Diabetes earns the high dose because **hyperglycaemia is independently teratogenic for the neural tube**; antiepileptics because they **antagonise folate metabolism directly**.

**MUST KNOW:**

- Supplementation reduces NTD **recurrence by ~70% (MRC Vitamin Study)**.
- **Do not confuse the other high-risk prescriptions: previous PRE-ECLAMPSIA → LOW-DOSE ASPIRIN from 12–16 weeks (plus calcium if intake is low). Previous PRETERM BIRTH → vaginal progesterone ± cerclage for a short cervix. SICKLE CELL DISEASE → folic acid 5 mg plus penicillin prophylaxis and transfusion planning.**
...
### 19. Iron Prophylaxis and Anemia Mukt Bharat

**PEARL:** Under **ANEMIA MUKT BHARAT**, a pregnant woman takes **one RED iron–folic acid tablet daily (60 mg elemental iron + 500 µg folic acid), starting at 14 WEEKS, for 180 DAYS ANTENATALLY AND 180 DAYS POSTPARTUM.** If she is **already anaemic (Hb <11 g/dL), the dose is DOUBLED to two tablets a day** and may begin as early as **8–10 weeks**.

**UNDERSTAND:** Iron starts **after the first trimester** because **nausea and vomiting are worst then and iron worsens them, destroying compliance**, while **fetal iron demand is small early and rises steeply in the second half**. The postpartum continuation exists because **pregnancy plus delivery blood loss depletes stores for months**, and inter-pregnancy intervals in India are often short.

**MUST KNOW:**

- **WHO anaemia in pregnancy <11 g/dL: MILD 10–10.9, MODERATE 7–9.9, SEVERE <7, VERY SEVERE <4 g/dL.** **WHO 2024: in the SECOND TRIMESTER the whole ladder shifts down 0.5 g/dL — anaemia <10.5, mild 9.5–10.4, moderate 7–9.4, severe <7 g/dL.**[^1] Iron deficiency is the commonest cause in India, then folate deficiency and haemoglobinopathies.
- **Anaemia contributes to ~20–40% of maternal deaths in India** and causes preterm birth, low birth weight and perinatal loss.
- **Route: ORAL first-line. IV IRON (ferric carboxymaltose, iron sucrose) after 12 weeks for moderate/severe anaemia when oral fails, is not tolerated or time is short. TRANSFUSION for Hb <7 g/dL near term, decompensation or active bleeding.**
- **The six AMB interventions:** prophylactic IFA, **deworming (albendazole 400 mg after the first trimester)**, behaviour-change communication with **delayed cord clamping**, point-of-care testing and treatment, **mandatory food fortification**, and addressing non-nutritional causes (malaria, fluorosis, haemoglobinopathies).
...
**PEARL:** Give **inactivated INFLUENZA (any trimester)** and **Tdap (ideally 27–36 weeks, in EVERY pregnancy)**. **All LIVE vaccines are contraindicated** (MMR, varicella, LAIV, oral polio, oral typhoid, BCG, yellow fever) and HPV is deferred — **but inadvertent live vaccination is NOT an indication for termination.**

**UNDERSTAND:** Two separate principles. Live vaccines are avoided on a **precautionary** basis — a theoretical risk of fetal infection that registries of thousands of accidentally vaccinated women have **never** borne out (no congenital rubella or varicella syndrome), so the correct response is **counselling, not termination**. **Tdap is timed late deliberately**: 27–36 weeks maximises **transplacental IgG transfer**, protecting the newborn from **pertussis** before its own primary immunisation.

**MUST KNOW:**

- **Safe in pregnancy:** inactivated influenza, **Tdap**, hepatitis B, **tetanus toxoid/Td** (Indian practice: **2 doses 4 weeks apart**, or a single booster if immunised within 3 years), COVID-19, and **RABIES post-exposure — never withheld, since rabies is universally fatal**.
- **Rubella and varicella vaccines are given POSTPARTUM** to seronegative women, before discharge; **avoid conception for 1 month**. Breastfeeding is not a contraindication.
...
**PEARL:** **NO additional calories in the first trimester.** Add **~340 kcal/day in the second** and **~450 kcal/day in the third** trimester.

**UNDERSTAND:** The total energy cost of pregnancy is ~**80,000 kcal**, almost all spent in the **last 20 weeks** when fetal growth and maternal fat deposition accelerate. First-trimester fetal mass is negligible — extra calories then simply produce maternal obesity.

**MUST KNOW:**

- **ICMR (India)** adds **~350 kcal/day** and **~23 g extra protein/day** through pregnancy — know both the IOM and ICMR figures.
...
- Features: **bleeding with grape-like vesicles**, uterus large for dates, **hyperemesis, EARLY PRE-ECLAMPSIA (<20 weeks — always think mole), HYPERTHYROIDISM** (hCG cross-reacts at the TSH receptor), and **THECA LUTEIN CYSTS** (a physiological response to high hCG; they resolve spontaneously).
- **Treatment: SUCTION EVACUATION** — never sharp curettage or medical induction (risk of perforation, embolisation and dissemination) — plus **anti-D if Rh-negative** and **mandatory contraception (not an IUCD) for 6–12 months**, because a new pregnancy makes hCG uninterpretable.
...
- **Continue chemotherapy until hCG normalises, then 2–3 CONSOLIDATION COURSES; follow hCG monthly for 12 months with strict contraception.**
...
**PEARL:** **The CERVIX is the discriminator.** **THREATENED** — closed os, viable pregnancy (expectant). **INEVITABLE** — open os, products still inside. **INCOMPLETE** — open os, partial expulsion. **COMPLETE** — closed os, empty uterus. **MISSED** — closed os, non-viable pregnancy retained (**misoprostol** is appropriate here). **SEPTIC** — fever, offensive discharge, tenderness. **An open os with products visible = inevitable/incomplete → SURGICAL EVACUATION.**

**UNDERSTAND:** Once the **cervix is open and products are in the canal**, the pregnancy cannot be saved and retained tissue risks **haemorrhage and ascending infection** — so the aim shifts from preservation to **prompt, complete emptying**. Misoprostol adds nothing when the cervix is already open; it is for the **closed cervix of a missed abortion**, where ripening is the obstacle.
...
### 26. Early Pregnancy Ultrasound and Diagnosing Pregnancy Failure
...
- **Also definitive of failure:** no embryo with heartbeat **≥2 weeks after a scan showing a sac without a yolk sac**, or **≥11 days after a scan showing a sac with a yolk sac**.
- **Suspicious but NOT diagnostic (rescan):** CRL <7 mm without heartbeat, MSD 16–24 mm without embryo, empty amnion, enlarged yolk sac (>7 mm), sac small relative to embryo (<5 mm difference).
- **DISCRIMINATORY ZONE: with β-hCG >1500–2000 mIU/mL an intrauterine sac SHOULD be visible on TVS** — if it is not, suspect **ectopic**.
- **A true gestational sac is ECCENTRIC with a DOUBLE DECIDUAL RING**; a **PSEUDOSAC** is central, with no yolk sac and no double ring.
- **Management of early pregnancy loss: expectant (up to 2 weeks), medical (misoprostol ± mifepristone), or surgical (MVA)** — offer choice unless there is haemorrhage, sepsis or instability, when surgical evacuation is indicated. **Anti-D if Rh-negative.**

**EXAM CONNECTION:** The single number is the question — **7 mm** for the CRL, **25 mm** for the sac. Both older values (5 mm, 16 mm) appear as distractors.

**REMEMBER:** *Sac 5, yolk 5.5, heart 6 — seven for the embryo, twenty-five for the sac, and when in doubt scan again.*
...
- **The ARIAS-STELLA REACTION IS NOT DIAGNOSTIC OF ECTOPIC** — it occurs in intrauterine pregnancy, ectopic, GTD, endometriosis and with exogenous oestrogen/gonadotrophin. It indicates **a hormonal effect, not a location**.
- **Diagnosis: TVS + SERIAL β-hCG.** Above the discriminatory zone (**1500–3500 mIU/mL**) an intrauterine sac should be visible. In normal early pregnancy **β-hCG rises ≥66% in 48 hours**; a **sub-optimal rise or plateau** suggests ectopic or failing pregnancy. TVS signs: empty uterus ± **pseudosac**, **blob sign** (adnexal mass), **bagel/tubal ring sign**, free fluid in the pouch of Douglas.
- **Other risk factors:** tubal surgery or **sterilisation/recanalisation**, ART and infertility, endometriosis, **smoking**, age >40. **An IUCD or progesterone-only pill reduces ectopics in absolute terms, but if pregnancy occurs despite one it is MORE LIKELY to be ectopic** (slowed tubal motility).
- **MEDICAL: methotrexate 50 mg/m² single dose** for a **stable, unruptured** ectopic with **β-hCG <5000, no fetal cardiac activity, mass <3.5 cm** — check hCG on **days 4 and 7 expecting a ≥15% fall**; avoid folic acid, NSAIDs, alcohol and intercourse. **SURGICAL: laparoscopic SALPINGECTOMY** (salpingostomy if the other tube is diseased) for rupture, instability or failed medical therapy.
...
**PEARL:** Fever, offensive purulent discharge, uterine tenderness and shock after an unsafe abortion = **SEPTIC ABORTION with ENDOTOXIC SHOCK**, and ***ESCHERICHIA COLI* is the commonest organism**. Infection is usually **POLYMICROBIAL** — anaerobes (*Bacteroides*, *Peptostreptococcus*), streptococci, and in the most feared form ***CLOSTRIDIUM PERFRINGENS***.

**UNDERSTAND:** Unsafe abortion introduces **vaginal and bowel flora into a necrotic, blood-filled uterine cavity — an ideal anaerobic culture medium** — and retained products are a persistent nidus. Gram-negative **endotoxin** then drives the septic shock cascade. Hence the two inseparable halves of treatment: **ANTIBIOTICS AND EVACUATION.** Antibiotics alone fail while the nidus remains.
...
### 29. Classifying and Diagnosing Hypertension in Pregnancy

**PEARL:** **GESTATIONAL HYPERTENSION = BP ≥140/90 arising AFTER 20 WEEKS without proteinuria or severe features in a previously normotensive woman** — a **RETROSPECTIVE, provisional diagnosis requiring BP to RETURN TO NORMAL BY 12 WEEKS POSTPARTUM** (if it persists, it was CHRONIC hypertension all along). **PRE-ECLAMPSIA can be diagnosed WITHOUT PROTEINURIA**, and **10–15% of eclamptic seizures occur in women with no proteinuria** — its absence is never reassuring. **Since the CHAP trial, ANTIHYPERTENSIVES ARE STARTED AT ≥140/90 in CHRONIC hypertension in pregnancy — not the old ≥160/110 — with a target below 140/90 and NO excess of small-for-gestational-age babies.**[^2]

**UNDERSTAND:** The 20-week line exists because **pregnancy-caused hypertension needs an established placenta with abnormal spiral artery invasion** — hypertension before 20 weeks is almost always pre-existing (or a **hydatidiform mole**, the classic exception). The postpartum rule follows the same logic: **placental disease resolves once the placenta is gone**. And pre-eclampsia is a **systemic ENDOTHELIAL disease, not a kidney disease** — proteinuria is only one manifestation, so waiting for it delays diagnosis in a woman already deteriorating.
...
**PEARL:** Pre-eclampsia is **failure of the SECOND WAVE of EXTRAVILLOUS (endovascular) TROPHOBLAST invasion of the SPIRAL arteries at 16–18 weeks**. The ischaemic placenta then releases the anti-angiogenic factors **sFlt-1 (soluble fms-like tyrosine kinase-1) and SOLUBLE ENDOGLIN, which are INCREASED — not decreased**, while pro-angiogenic **PlGF, VEGF and PAPP-A FALL**. **LOW-DOSE ASPIRIN 150 mg at night started BEFORE 16 WEEKS is the proven prevention** (ASPRE trial); **calcium helps only where dietary intake is low, and salt restriction and antioxidants do NOT work.**

**UNDERSTAND:** Normally endovascular trophoblast **replaces the endothelium and destroys the muscular media**, converting spiral arteries into **flaccid, low-resistance conduits that cannot vasoconstrict**. If the second wave fails, the **myometrial segments keep their muscular wall and stay responsive to vasoconstrictors** → placental ischaemia → **sFlt-1 mops up VEGF and PlGF** and **soluble endoglin blocks NO-dependent vasodilatation and TGF-β signalling** → generalised **maternal ENDOTHELIAL DYSFUNCTION** with vasospasm, capillary leak, proteinuria and coagulation activation. **Aspirin must start before 16 weeks because that is while placentation is still happening** — later, there is nothing left to modify.
...
- **Obsolete tests still asked: the ROLL-OVER TEST at 28–32 weeks** — BP taken lateral, then supine; a **≥20 mmHg rise in diastolic** is positive (~33% later become hypertensive) — and the **ANGIOTENSIN II SENSITIVITY TEST**. Both reflect loss of the normal **refractoriness to angiotensin II**.
...
**PEARL:** Headache, visual disturbance, epigastric/RUQ pain and heavy proteinuria = **SEVERE PRE-ECLAMPSIA WITH IMPENDING ECLAMPSIA — the immediate next step is IV MAGNESIUM SULPHATE**, before steroids and before any decision about delivery.

**UNDERSTAND:** Magnesium goes first because **eclampsia can occur within minutes and is the event that kills**, whereas steroids act over 24–48 hours and delivery can be organised in parallel.

**MUST KNOW:**

- **Antihypertensives for BP ≥160/110: LABETALOL, NIFEDIPINE or HYDRALAZINE (target ~140–150/90–100). ACE inhibitors, ARBs and atenolol are CONTRAINDICATED antenatally.** Reduce BP in a **controlled** way — a precipitous fall compromises placental perfusion.
- **DELIVERY IS THE ONLY CURE. Timing: ≥37 weeks for pre-eclampsia WITHOUT severe features; ≥34 weeks (after steroids) WITH severe features; IMMEDIATE delivery regardless of gestation for ECLAMPSIA, HELLP, pulmonary oedema, DIC, ABRUPTION, uncontrollable hypertension or non-reassuring fetal status.** Below 34 weeks with stable disease: **antenatal corticosteroids and expectant management under close surveillance.**
- **HELLP SYNDROME — Haemolysis (schistocytes, raised LDH and bilirubin), Elevated Liver enzymes, Low Platelets — presents with EPIGASTRIC PAIN and may occur with only mildly raised or normal blood pressure.** Complications include **SUBCAPSULAR LIVER HAEMATOMA and rupture**.
- **Prophylaxis: LOW-DOSE ASPIRIN (75–150 mg at night) from 12–16 weeks in high-risk women, plus calcium where intake is low.**
...
### 32. Magnesium Sulphate — Regimens, Monitoring and Toxicity

**PEARL:** **MAGNESIUM DOES NOT LOWER BLOOD PRESSURE — it is an ANTICONVULSANT, not an antihypertensive.** **Toxicity in order: LOSS OF THE PATELLAR (deep tendon) REFLEX at ~10 mEq/L — the EARLIEST sign; RESPIRATORY DEPRESSION (<12/min) at ~12 mEq/L; CARDIAC ARREST at ~25–30 mEq/L.** Therapeutic level **4–7 mEq/L (4.8–8.4 mg/dL)**. **REDUCED URINE OUTPUT IS NOT A FEATURE OF TOXICITY — IT IS A CAUSE OF IT.** **Antidote: 1 g (10 mL of 10%) CALCIUM GLUCONATE IV.**

**UNDERSTAND:** Magnesium is a **physiological calcium antagonist** — it blocks calcium entry at the presynaptic terminal and cuts acetylcholine release, so **neuromuscular transmission fails from the most sensitive structures (reflex arcs) down to the least (cardiac conduction)**, giving the predictable ladder of signs; **calcium competes at the same site and reverses it instantly**. Its anticonvulsant action is **cerebral vasodilatation, NMDA receptor blockade and membrane stabilisation** — none of which usefully lowers BP. And because it is **cleared entirely by the kidney with no hepatic metabolism**, the **LOADING dose (set by volume of distribution) is unchanged in renal failure but the MAINTENANCE dose must be reduced** — oliguria simply lets the drug accumulate.
...
**UNDERSTAND:** PRES is **VASOGENIC** oedema from failure of cerebral autoregulation under an abrupt pressure surge plus endothelial dysfunction. It is **posterior** because the **vertebrobasilar circulation has sparse sympathetic innervation**, so the occipital and parietal lobes lose autoregulatory protection first. Because the fluid is **interstitial, not cytotoxic**, **DWI is not restricted (high ADC)** — the single feature separating it from infarct, and the reason it resolves once pressure is controlled.
...
**EXAM CONNECTION:** The MRI plus eclampsia makes PRES the answer; the distractors are haemorrhages, which would be hyperdense on CT and asymmetrical.
...
### 35. Diabetes in Pregnancy — Screening, Diagnosis and Classification

**PEARL:**
**OVERT (pregestational) diabetes = FASTING ≥126 mg/dL, RANDOM ≥200 mg/dL, or HbA1c ≥6.5%.**
...
**UNDERSTAND:** Two time points test two different things. **At the first visit, hyperglycaemia means the woman was ALREADY diabetic before conception** — which implies teratogenic exposure during organogenesis, so **HbA1c (an integrated measure of preconception control) is the right early test**. **At 24–28 weeks, insulin resistance from placental hormones (hPL, progesterone, cortisol, prolactin) peaks** — so that is when true gestational diabetes declares itself. The IADPSG thresholds are **outcome-based** (from the **HAPO study**, the level conferring a **1.75-fold** rise in macrosomia, cord C-peptide and neonatal fat) — which is why one abnormal value suffices.
...
### 36. Overt versus Gestational Diabetes — Fetal and Neonatal Effects
...
- **CAUDAL REGRESSION (sacral agenesis) and SIRENOMELIA are the most SPECIFIC anomalies; CARDIAC defects are the COMMONEST (VSD most often; also TGA, ASD, hypoplastic left heart), then NEURAL TUBE and renal defects.** Small left colon syndrome is another. **Malformation risk correlates directly with PERICONCEPTIONAL HbA1c.**
- **Neonatal problems: HYPOGLYCAEMIA (feed early, monitor), hypocalcaemia, hypomagnesaemia, POLYCYTHAEMIA and hyperbilirubinaemia, RESPIRATORY DISTRESS SYNDROME (insulin ANTAGONISES cortisol-driven surfactant production, so lung maturity is DELAYED), HYPERTROPHIC CARDIOMYOPATHY, and birth injury from SHOULDER DYSTOCIA.** Later: **childhood obesity**.
...
### 37. Diabetes in Pregnancy — Drugs, Targets and Delivery

**PEARL:** **INSULIN is the drug of choice — a large polypeptide that does NOT cross the placenta.** **Sulfonylureas (tolbutamide, chlorpropamide) DO cross freely** and cause fetal hyperinsulinaemia and neonatal hypoglycaemia; **metformin and glyburide cross but are acceptable with monitoring; PIOGLITAZONE is NOT recommended.** Targets: **fasting <95, 1-hour postprandial <140, 2-hour <120 mg/dL; HbA1c <6.0–6.5%.** **Sulfonylureas do NOT cause pregnancy-induced hypertension** (a planted false association).

**UNDERSTAND:** The placenta makes **hPL, progesterone, cortisol and prolactin — all insulin antagonists** — so requirements **rise steeply, roughly doubling to trebling by the third trimester**, and cannot be met by oral agents. The same antagonism explains why requirements **fall in the first trimester** (fetal glucose draw and nausea) and **CRASH the moment the placenta is delivered**.

**MUST KNOW:**

- **CUT THE INSULIN DOSE IMMEDIATELY AFTER DELIVERY OF THE PLACENTA** to roughly the pre-pregnancy amount, or stop it altogether in GDM.
- **Around a planned induction: give the usual NIGHT dose of intermediate-acting insulin and WITHHOLD THE MORNING DOSE.** In active labour, run an **insulin–dextrose infusion targeting capillary glucose ~70–110 mg/dL** — labour is profound exercise, yet **maternal hyperglycaemia in labour directly causes NEONATAL HYPOGLYCAEMIA**.
- **DELIVERY TIMING: diet-controlled GDM 39–40+6 weeks; insulin/oral-agent-controlled GDM 39–39+6 weeks; poor control 37–38+6 weeks; OVERT diabetes on insulin ~38 weeks** (higher stillbirth risk, vasculopathy and macrosomia).
...
**PEARL:** **WARFARIN IS TERATOGENIC IN THE FIRST TRIMESTER (weeks 6–12) — WARFARIN EMBRYOPATHY: nasal hypoplasia, STIPPLED EPIPHYSES (chondrodysplasia punctata), limb hypoplasia, plus later CNS abnormalities and fetal haemorrhage.** With a **previous embryopathy or a dose >5 mg/day, REPLACE warfarin with HEPARIN/LMWH in the first trimester**; at **≤5 mg/day it may be continued**. **Switch to LMWH at ~36 weeks, then UNFRACTIONATED heparin near delivery, and stop on the day of delivery.** **Antiphospholipid syndrome in pregnancy is treated with LOW-DOSE ASPIRIN PLUS HEPARIN.**

**UNDERSTAND:** **Warfarin CROSSES the placenta; HEPARIN (unfractionated and LMW) DOES NOT** — it is a large polar molecule. That one pharmacological fact governs the whole protocol. Warfarin is nonetheless preferred in mid-pregnancy for **MECHANICAL HEART VALVES**, because heparin is less effective at preventing valve thrombosis — a genuine maternal-versus-fetal trade-off requiring counselling.
...
- **NEONATAL LUPUS: annular/photosensitive rash (RESOLVES as maternal antibody clears over ~6 months), cytopenias, transaminitis — and the ONE PERMANENT feature, CONGENITAL HEART BLOCK.** Mortality ~20% in affected fetuses.
- **MATERNAL HYDROXYCHLOROQUINE reduces the risk of heart block**, especially after a previously affected child (recurrence otherwise ~15–20%).
- **The mother may be entirely ASYMPTOMATIC** — anti-Ro positivity, not clinical lupus, is what matters.
- **SLE in pregnancy: conceive after 6 MONTHS OF REMISSION; flares are commonest postpartum. Continue HYDROXYCHLOROQUINE. AZATHIOPRINE, tacrolimus and steroids are permitted; METHOTREXATE, MYCOPHENOLATE and CYCLOPHOSPHAMIDE ARE CONTRAINDICATED.** Add **low-dose aspirin** for pre-eclampsia prophylaxis.
- **LUPUS NEPHRITIS FLARE vs PRE-ECLAMPSIA: flare favours ACTIVE URINARY SEDIMENT (red cell casts), RISING anti-dsDNA, FALLING COMPLEMENT and other organ involvement; pre-eclampsia favours rising uric acid, raised transaminases, a bland sediment and NORMAL complement.**
...
### 40. Liver Disease in Pregnancy — Cholestasis, AFLP and HELLP
...
- **Predisposed by MULTIPARITY, ADVANCED AGE (>30), MULTIFETAL gestation, PRE-ECLAMPSIA, African ancestry and smoking.**
...
### 42. Renal Changes and Acute Kidney Injury in Pregnancy

**PEARL:** The kidneys **ENLARGE by ~1–1.5 cm; GFR and renal plasma flow RISE ~50%, so SERUM CREATININE AND UREA FALL** (a creatinine of 1.0 mg/dL is **abnormal** in pregnancy); **GLYCOSURIA occurs in up to 50% of normal women; and there is PHYSIOLOGICAL HYDRONEPHROSIS — MORE MARKED ON THE RIGHT, not the left.**

**UNDERSTAND:** Right-sided predominance has two anatomical causes — **DEXTROROTATION of the gravid uterus**, and the **right ureter crossing the iliac and ovarian vessels at a sharper angle** while the **left is cushioned by the sigmoid colon** — with progesterone-induced smooth muscle relaxation on top. That stasis is why **asymptomatic bacteriuria progresses to PYELONEPHRITIS in up to 30% of untreated pregnant women**, and why pregnancy is one of the few settings where asymptomatic bacteriuria **must** be treated.

**MUST KNOW:**

- **Glycosuria occurs because the rise in GFR exceeds tubular reabsorptive capacity — it does NOT indicate diabetes and is useless as a GDM screen.**
- **OBSTETRIC causes of AKI: PRE-ECLAMPSIA/ECLAMPSIA and HELLP, ABRUPTIO PLACENTAE, POSTPARTUM HAEMORRHAGE and hypovolaemic shock, SEPTIC ABORTION and puerperal sepsis, ACUTE FATTY LIVER, amniotic fluid embolism.** **ANTIPHOSPHOLIPID SYNDROME causes renal injury but is a MEDICAL/thrombotic, not obstetric, cause.**
- **Bilateral RENAL CORTICAL NECROSIS is classically associated with ABRUPTION and SEPTIC ABORTION** — a cause of irreversible renal failure.
- **Postpartum, consider ATYPICAL HUS / pregnancy-associated thrombotic microangiopathy** when renal failure and haemolysis persist or worsen after delivery — treat with **ECULIZUMAB**.
...
**PEARL:** **TOTAL T3 and TOTAL T4 RISE throughout pregnancy** (oestrogen raises THYROXINE-BINDING GLOBULIN) while **FREE T3 and FREE T4 remain essentially UNCHANGED** — so **only FREE hormone levels assess thyroid function in pregnancy**. **TSH FALLS slightly in the FIRST TRIMESTER** because **hCG cross-reacts with the TSH receptor**, then normalises.

**UNDERSTAND:** Oestrogen increases the **sialylation of TBG, prolonging its half-life**, so the carrier pool expands and the thyroid makes more hormone to keep the free fraction constant. Meanwhile **hCG shares the α-subunit with TSH** and weakly stimulates its receptor — which is why **TSH is lowest exactly when hCG peaks (8–11 weeks)**, and why **hCG-driven thyrotoxicosis occurs in hyperemesis gravidarum and molar pregnancy**.

**MUST KNOW:**

- **Use trimester-specific TSH ranges** (roughly <2.5 mIU/L in the first trimester).
...
### 45. Varicella in Pregnancy and the Newborn

**PEARL:** **CONGENITAL (FETAL) VARICELLA SYNDROME is HIGHEST when maternal infection occurs between 13 and 20 WEEKS (~2%)** — lower before 13 weeks (~0.4%) and rare after 20. **NEONATAL VARICELLA is the lethal risk: maternal rash from 5 DAYS BEFORE to 2 DAYS AFTER DELIVERY**, with mortality up to **30%**.

**UNDERSTAND:** The congenital syndrome is essentially **intrauterine SHINGLES** — the virus becomes latent in fetal dorsal root ganglia and reactivates in utero, which is why the **scarring is DERMATOMAL and the underlying limb hypoplastic (denervation of the developing limb bud)**; the 13–20 week peak is when **limb and nervous system development is still active but the fetus cannot yet mount an immune response**. In the −5 to +2 day window the **virus crosses transplacentally but maternal IgG has not yet been made and transferred** — the baby meets the virus unprotected.

**MUST KNOW:**

- **Congenital varicella syndrome: CICATRICIAL SKIN SCARRING in a dermatomal/zigzag pattern, LIMB HYPOPLASIA, microcephaly and cortical atrophy, chorioretinitis, microphthalmia, cataract, neurogenic bladder/hydronephrosis.**
- **Neonate in the danger window: VZIG at birth plus IV ACYCLOVIR 10 mg/kg 8-hourly once lesions appear.**
- **Pregnant woman with uncomplicated chickenpox: ORAL ACYCLOVIR 800 mg five times daily × 7 days**, given if she presents within 24 hours of the rash after 20 weeks.
- **MATERNAL VARICELLA PNEUMONIA is the major maternal danger (10–20% of adult cases, worse in pregnancy and in smokers) — IV ACYCLOVIR.**
...
**PEARL:** **Caesarean is indicated ONLY if there are ACTIVE GENITAL LESIONS OR PRODROMAL SYMPTOMS AT THE TIME OF LABOUR** — a history of herpes alone is not an indication. With no active lesions, **VAGINAL DELIVERY is appropriate**. **SUPPRESSIVE ACYCLOVIR from 36 WEEKS** reduces recurrences and the need for caesarean.

**UNDERSTAND:** Neonatal herpes is acquired **during passage through an infected birth canal (85%)** — so risk is a function of **viral shedding at the moment of delivery**, not of past infection. Risk is far higher with a **PRIMARY infection near term (30–50%) than with a RECURRENCE (<1–3%)**, because in primary infection the mother has **no protective transplacental IgG** to pass on and sheds more virus for longer.

**MUST KNOW:**

- **Caesarean should ideally be done BEFORE or WITHIN 4–6 HOURS OF MEMBRANE RUPTURE** — after prolonged rupture, ascending infection has already occurred and the benefit falls.
- **A PRIMARY episode in the THIRD TRIMESTER (especially within 6 weeks of delivery) is the highest-risk situation and is an indication for CAESAREAN REGARDLESS of visible lesions**, plus treatment of mother and neonate.
- **NEONATAL HERPES has three forms: SKIN-EYE-MOUTH (best prognosis), CNS (encephalitis, often at 2–3 weeks, high morbidity), DISSEMINATED (multi-organ, first week, highest mortality).** Treat with high-dose IV acyclovir.
- **ACYCLOVIR IS SAFE in pregnancy and lactation.**
- **Lesions on buttocks or thighs (non-genital) can be covered and vaginal delivery permitted. AVOID FETAL SCALP ELECTRODES and invasive monitoring in any woman with herpes.**
...
### 47. Urinary Tract Infection in Pregnancy — Asymptomatic Bacteriuria and Pyelonephritis

**PEARL:** **SCREEN EVERY PREGNANT WOMAN with a urine culture at the first antenatal visit and TREAT ASYMPTOMATIC BACTERIURIA** — untreated, about **25% become symptomatic and 20–30% develop PYELONEPHRITIS**. Established pyelonephritis needs **ADMISSION, urine and blood cultures, IV ANTIBIOTICS (third-generation cephalosporin), IV crystalloids keeping urine output ≥50 mL/hour, and an oral switch once AFEBRILE FOR 24–48 HOURS — a TOTAL COURSE OF 10–14 DAYS (not 5), then SUPPRESSIVE PROPHYLAXIS (nitrofurantoin at night) FOR THE REST OF PREGNANCY** with monthly cultures.

**UNDERSTAND:** Pregnancy turns a harmless colonisation into a dangerous one. **Progesterone relaxes ureteric smooth muscle and the gravid uterus compresses the ureters (RIGHT more than left)**, producing hydronephrosis, stasis and reflux — a perfect ascending route, with glycosuria adding substrate. Once ascended, **endotoxin release causes ENDOTHELIAL INJURY**, hence **ARDS (up to 10%), septic shock, haemolysis and preterm labour** — which is why admission and measured hydration are mandatory, not optional.

**MUST KNOW:**

- **ASB = ≥10⁵ CFU/mL of a single organism on a clean-catch midstream specimen with no symptoms.** Prevalence 2–7%. Treat **3–7 days** and **repeat culture as test of cure**; recurrence → suppression for the rest of pregnancy.
- ***E. COLI* causes ~70–80%**; also *Klebsiella*, *Proteus*, and **GROUP B STREPTOCOCCUS — whose presence in urine mandates intrapartum GBS prophylaxis regardless of the later swab.**
- **Pyelonephritis is the commonest serious medical complication of pregnancy, occurs most often in the SECOND TRIMESTER, and is RIGHT-SIDED in about half.**
- **SAFE: penicillins, cephalosporins (cephalexin), amoxicillin/co-amoxiclav, NITROFURANTOIN (avoid at term and in G6PD deficiency — haemolysis and neonatal jaundice), fosfomycin single dose, erythromycin. AVOID: FLUOROQUINOLONES (cartilage), TETRACYCLINES (teeth and bone), TRIMETHOPRIM/cotrimoxazole in the first trimester (folate antagonism) and near term (kernicterus), AMINOGLYCOSIDES (ototoxicity) unless essential.**
...
**PEARL:** After confirmed acute maternal parvovirus B19 infection (**IgM positive, IgG negative**), the next step is **SERIAL MIDDLE CEREBRAL ARTERY PEAK SYSTOLIC VELOCITY (MCA-PSV) DOPPLER every 1–2 weeks for 10–12 weeks** — to detect fetal anaemia **before** hydrops develops.

**UNDERSTAND:** B19 infects and lyses **erythroid progenitors** (its receptor is the **P antigen/globoside**), causing pure red cell aplasia. Fetal anaemia lowers viscosity and raises cardiac output, so blood **flows faster** through the middle cerebral artery — exactly what MCA-PSV measures. **>1.5 MoM** predicts moderate-to-severe anaemia **non-invasively**, allowing intervention before **hydrops fetalis** (high-output cardiac failure). Invasive fetal blood sampling is reserved for an abnormal Doppler.
...
**PEARL:** Painful APH with a **tense, tender uterus larger than dates, absent fetal heart sounds and pre-eclampsia** = **abruption with fetal demise**. If the mother is stable and the cervix is favourable, management is **antihypertensives + ARTIFICIAL RUPTURE OF MEMBRANES and VAGINAL delivery — NOT caesarean.**

**UNDERSTAND:** Once the fetus is dead the only goal is **maternal safety**, and a caesarean adds surgical bleeding to a woman who is already **coagulopathic** (DIC in up to 30% of severe cases). **Amniotomy is therapeutic, not merely expedient**: releasing liquor **reduces intrauterine pressure, decreases further thromboplastin entry into the maternal circulation and accelerates labour** — an abrupted uterus is usually already contracting hard. **Tocolytics are exactly wrong.**

**MUST KNOW:**

- **Grades (Page): 0 — retrospective, on placental examination; 1 — mild, no fetal distress; 2 — fetus alive but distressed; 3 — FETAL DEATH (3a without, 3b WITH coagulopathy).**
- **CONCEALED haemorrhage means the visible bleeding grossly underestimates the loss** — shock out of proportion to the external bleed is the hallmark. A **COUVELAIRE uterus** (blood extravasated into the myometrium, bluish and boggy) may be found at caesarean and is **NOT itself an indication for hysterectomy**.
- **Diagnosis is CLINICAL — ULTRASOUND IS INSENSITIVE; a normal scan does not exclude abruption.**
- **Caesarean is for a LIVE, viable fetus with distress, or an unstable mother / one who cannot deliver quickly.**
- Check **fibrinogen, platelets, PT/aPTT and cross-match**; give **anti-D** if Rh-negative (with a Kleihauer test).
...
**PEARL:** **DNA FINGERPRINTING is the ABSOLUTE PROOF of MONOZYGOSITY.** Other pointers: **DIFFERENT SEXES prove DIZYGOSITY; MONOCHORIONICITY proves MONOZYGOSITY; and RECIPROCAL SKIN GRAFTS are ACCEPTED between monozygotic and REJECTED between dizygotic twins** (the historical test).

**UNDERSTAND:** Only DNA identity is definitive because **every other marker can mislead**: monozygotic twins may be **DICHORIONIC** if the split occurs within 3 days, so two placentas do not exclude monozygosity; and same-sex dizygotic twins with fused placentas can look monochorionic on gross inspection. **Skin grafting works because rejection depends on HLA identity** — exactly what DNA fingerprinting measures directly.
...
### 54. Twin Pregnancy — Timing and Mode of Delivery

**PEARL:** **The presentation of the FIRST twin decides the mode of delivery. VERTEX → attempt vaginal; BREECH or TRANSVERSE → caesarean.** Timing: **DCDA 37–38 weeks; MCDA 36–37+6 weeks; MCMA 32–34 weeks by caesarean.**

**UNDERSTAND:** A non-vertex first twin risks **INTERLOCKING (the after-coming head of twin 1 locking with the head of a vertex twin 2)**, **head entrapment above an incompletely dilated cervix**, and **cord prolapse** — none of which can be reliably managed once labour is under way, so the decision is made beforehand. **LOCKED TWINS** is the rare catastrophe when twin 1 is breech and twin 2 cephalic and the chins interlock.

**MUST KNOW:**

- **Second twin: if breech → assisted breech delivery; if transverse → INTERNAL PODALIC VERSION under anaesthesia followed by BREECH EXTRACTION.** Conjoined and monoamniotic twins always need caesarean.
- **All twin pregnancies need earlier and more frequent scans, iron and folate supplementation, and surveillance for pre-eclampsia and growth restriction.**
...
- **Normal criteria: NST — ≥2 accelerations of ≥15 bpm for ≥15 seconds in 20–40 minutes. BREATHING — ≥1 episode of rhythmic breathing ≥30 seconds. MOVEMENT — ≥3 discrete body/limb movements. TONE — ≥1 episode of extension with return to flexion. FLUID — a single deepest pocket ≥2 cm in two perpendicular planes.**
- **Interpretation: 8–10 normal; 6 equivocal (repeat in 24 h, or deliver if term); 4 suspected asphyxia (deliver if ≥32 weeks); 0–2 DELIVER immediately. An abnormal NST or OLIGOHYDRAMNIOS OVERRIDES an otherwise reassuring score.**
...
- **DR C BRAVADO: Define Risk, Contractions, Baseline RAte, VAriability, Decelerations, Overall impression.**
...
- **REDUCED VARIABILITY (<5 bpm for >50 minutes) is the most ominous single feature after a prolonged bradycardia** — causes include fetal sleep (up to 40 minutes), hypoxia/acidosis, prematurity, drugs (opioids, magnesium, sedatives), fetal anomaly.
- **A SINUSOIDAL pattern — a smooth regular sine wave with absent variability — means SEVERE FETAL ANAEMIA (fetomaternal haemorrhage, Rh disease, vasa praevia) and is an emergency.**
...
### 60. The Partograph and Recognising Obstructed Labour

**PEARL:** Plotting begins **in ACTIVE LABOUR (classically at 4 cm), and the first plot is placed ON or BEFORE the ALERT LINE.** The **ALERT LINE** runs at **1 cm/hour** from 4 cm to 10 cm; the **ACTION LINE lies 4 HOURS to its RIGHT**. Crossing the alert line means **transfer/reassess**; crossing the action line means **INTERVENE**. **The MODIFIED WHO partograph OMITS THE LATENT PHASE.**

**UNDERSTAND:** The partograph is a **graphical early-warning system, not a diagnostic test**. The latent phase is too variable in duration to be judged against a fixed slope — plotting it would generate false alarms and unnecessary caesareans. The 4-hour gap between the lines exists because **most labours that lag briefly still progress spontaneously**, so the alert line buys time for referral while the action line marks where delay itself becomes dangerous (obstructed labour, rupture, fistula, sepsis).

**MUST KNOW:**

- **THREE groups of observations: FETAL (heart rate, membranes/liquor, moulding), PROGRESS (cervical dilatation X, descent in fifths O, contractions per 10 minutes and duration), MATERNAL (pulse, BP, temperature, urine output, drugs and fluids).**
...
**EXAM CONNECTION:** Sequence questions — memorise the order and note that **crowning falls during extension**.
...
### 63. Fetal Skull Diameters and Malpresentation

**PEARL:** **The MENTOVERTICAL (13.5–14 cm) is the LONGEST diameter, presented in BROW presentation — which CANNOT deliver vaginally at term.** Palpating the **ANTERIOR FONTANELLE PLUS THE SUPRAORBITAL RIDGES means BROW.**

**UNDERSTAND:** The whole logic of labour mechanics is **presenting the SMALLEST possible diameter**. Full **flexion gives 9.5 cm** and delivers easily; **complete extension (face) also gives 9.5 cm** and can deliver; but the **INTERMEDIATE, half-extended position (brow) presents the longest diameter of the skull and is the ONE THAT CANNOT DELIVER.** Brow is unstable — it usually converts to a vertex (by flexion) or a face (by further extension).

**MUST KNOW:**

| Diameter | Size | Presentation |
| --- | --- | --- |
| **Suboccipitobregmatic** | **9.5 cm** | Fully flexed **vertex** (ideal) |
| Suboccipitofrontal | 10 cm | Partly deflexed vertex |
| **Occipitofrontal** | **11.5 cm** | Military/deflexed vertex (occipitoposterior) |
| **Mentovertical** | **13.5–14 cm (longest)** | **Brow** |
...
- **Persistent BROW at term = CAESAREAN. FACE: MENTO-ANTERIOR can deliver vaginally by flexion; MENTO-POSTERIOR CANNOT** (the neck would have to extend further) and needs caesarean. In face presentation the **facial oedema and bruising are alarming but resolve**; **avoid vacuum extraction**.
- **Identifying the presentation vaginally: VERTEX — posterior fontanelle (triangular, three sutures) with a flexed head; BROW — anterior fontanelle (diamond, four sutures) PLUS supraorbital ridges and root of the nose; FACE — mouth, nose, malar eminences and orbital ridges (the mouth and two malar prominences form a TRIANGLE, versus the anus and ischial tuberosities of a breech, which lie in a STRAIGHT LINE).**
- **Causes of deflexed attitudes: contracted pelvis, prematurity, polyhydramnios, multiparity with a lax abdominal wall, ANENCEPHALY (classically face presentation), fetal neck masses, cord round the neck.**
- **ENGAGEMENT = the BIPARIETAL diameter (9.5 cm) has passed the pelvic brim — clinically, when only 2/5 or less of the head is palpable abdominally.**

**EXAM CONNECTION:** Anterior fontanelle + supraorbital ridge → **brow → mentovertical**. Straight recall of longest/shortest, or a matching grid.
...
**PEARL:** The **MID-PELVIS (plane of least dimensions, at the ISCHIAL SPINES) is the NARROWEST plane — its INTERSPINOUS DIAMETER (~10.5 cm) is the SHORTEST diameter in the whole pelvis** and the commonest site of arrest. The **DIAGONAL CONJUGATE is the ONLY conjugate that can be measured clinically (~12–12.5 cm, from the lower border of the symphysis to the sacral promontory); the OBSTETRIC CONJUGATE (~10 cm, the shortest and functionally critical AP diameter of the inlet) is derived by SUBTRACTING 1.5–2 cm.**

**UNDERSTAND:** The ischial spines matter for three reasons that all follow from their position: they are the **reference point for STATION (station 0 = engagement)**, the **narrowest passage (hence DEEP TRANSVERSE ARREST occurs here)**, and the **landmark for the PUDENDAL NERVE BLOCK**. The obstetric conjugate runs from the **inner, most prominent point behind the symphysis** to the promontory — a point no examining finger can reach, hence the clinical work-around. And because the **inlet is widest TRANSVERSELY (13 cm) while the outlet is widest ANTEROPOSTERIORLY**, the head must **engage transversely and deliver anteroposteriorly — which is precisely why INTERNAL ROTATION must occur.**
...
- **The TRUE pelvis lies below the brim and is the birth canal; the FALSE pelvis above it merely supports the gravid uterus.**

**EXAM CONNECTION:** Labelled diagram at the level of the spines → **mid-pelvis**. Fingers reaching the promontory → **diagonal conjugate**. Feature-matching: face-to-pubis → **anthropoid**.

**REMEMBER:** *The spines mark station zero and the narrowest plane — everything gets stuck there. Gynaecoid delivers, android arrests, anthropoid goes face-to-pubis, platypelloid stays transverse.*
...
### 66. Breech Presentation and External Cephalic Version

**PEARL:** **FRANK (extended) BREECH = FLEXION at the hip, EXTENSION at the knee** — the **commonest (~65%), especially in primigravidae, and the safest for vaginal delivery**. **FOOTLING breech has the HIGHEST cord prolapse risk → caesarean.** **PRIMIGRAVIDITY IS NOT A CONTRAINDICATION to ECV**, which is done at **36 weeks (nulliparas) / 37 weeks (multiparas)** in a unit with **facilities for immediate caesarean**.

**UNDERSTAND:** All breech nomenclature reduces to **two joints**. Frank breech is safest because the buttocks plus extended thighs form a **well-fitting, dilating presenting part** that fills the lower segment; a footling breech leaves gaps, so the cord can prolapse and the cervix can trap the after-coming head. ECV is timed at 36–37 weeks because **spontaneous version still occurs before then**, and because **if the procedure precipitates a complication the baby is mature enough to be delivered safely**. Success (~50–60%) depends on **adequate liquor, a non-engaged breech, a relaxed uterus and multiparity** — hence routine **TOCOLYSIS (terbutaline)**.
...
| **Complete / flexed** | Flexed | Flexed | Cross-legged; commoner in multiparas |
| **Footling** | **Extended** | Extended | **Highest cord prolapse risk** → caesarean |
| Kneeling | Extended | Flexed | Rare |

- **CONTRAINDICATIONS TO ECV: placenta praevia or other APH (or recent bleeding <1 week), RUPTURED MEMBRANES/oligohydramnios, MULTIPLE PREGNANCY, any indication for caesarean anyway, a non-reassuring fetal heart, major uterine anomaly, severe pre-eclampsia, previous classical caesarean.**
...
- **FILLING THE BLADDER with 500–700 mL of saline (the VAGO method)** elevates the presenting part and is useful when transfer will take time; **TOCOLYSIS (terbutaline)** reduces contractions; keep the cord warm, moist and minimally handled.
- **Delivery: IMMEDIATE CAESAREAN unless the cervix is FULLY DILATED and instrumental vaginal delivery is faster and safe. If the fetus is dead — await vaginal delivery.** The **decision-to-delivery interval determines the outcome**.
- **OCCULT prolapse** = cord alongside, not below, the presenting part — presenting as **variable decelerations**.
- **Risk factors: MALPRESENTATION (transverse lie, breech — especially FOOTLING), POLYHYDRAMNIOS, PREMATURITY and low birth weight, MULTIPLE PREGNANCY, a high or unengaged head, long cord, and IATROGENIC causes — ARTIFICIAL RUPTURE OF MEMBRANES with a high presenting part, and internal podalic version. NEVER RUPTURE MEMBRANES WHEN THE HEAD IS UNENGAGED.**
...
**PEARL:** **HEART DISEASE IS NOT A CONTRAINDICATION to induction — vaginal delivery is PREFERRED in most cardiac patients.** Contraindications are essentially **the contraindications to labour itself**: **placenta and vasa praevia, transverse lie, cord prolapse, a PELVIC TUMOUR obstructing the canal, a previous CLASSICAL caesarean or cavity-entering myomectomy, ACTIVE GENITAL HERPES, invasive cervical cancer, severe CPD.** The **MODIFIED BISHOP SCORE has FIVE components: DILATATION, CERVICAL LENGTH (which replaced effacement), CONSISTENCY, POSITION and STATION** — **≥6–8 is FAVOURABLE; ≤5 warrants RIPENING first.**

**UNDERSTAND:** Cardiac patients tolerate **labour better than surgery** — caesarean brings greater blood loss, larger fluid shifts, anaesthetic risk and more thromboembolism. The dangerous moment in labour is the **IMMEDIATE POSTPARTUM AUTOTRANSFUSION** of ~500 mL, so the strategy is a **short, painless second stage with an assisted vaginal delivery, good epidural analgesia and careful fluid balance**. The Bishop score, meanwhile, measures **how far the cervix has already travelled towards labour on its own**: a posterior, long, firm cervix has not begun the **biochemical remodelling** (collagen breakdown, rising hyaluronic acid and water) that must precede dilatation, so oxytocin only produces painful contractions against an unyielding cervix — failed induction and caesarean. **Prostaglandins do that remodelling directly.**

**MUST KNOW:**

- **Cardiac disease is the leading INDIRECT cause of maternal death.** Caesarean is reserved for obstetric indications plus a few cardiac ones: **severe aortic stenosis, aortic root dilatation/MARFAN, EISENMENGER SYNDROME, pulmonary hypertension, and a woman anticoagulated with WARFARIN at the time of labour** (fetal intracranial bleed).
- **A previous LOWER SEGMENT transverse caesarean is NOT a contraindication — VBAC is permissible**, though **prostaglandins increase scar rupture risk**, so mechanical methods (Foley) or careful oxytocin are preferred. **A previous CLASSICAL (vertical) incision IS a contraindication.**
- **Every Bishop component moves in the same direction as labour: SOFTER, SHORTER, MORE DILATED, MORE ANTERIOR, LOWER = higher score = more favourable.** A low score predicts **failed induction and caesarean**, particularly in nulliparas.
- **RIPENING METHODS: PGE2 (dinoprostone) gel/pessary; MISOPROSTOL (PGE1 — cheap, heat-stable, effective, but higher hyperstimulation risk and CONTRAINDICATED with a previous caesarean scar); a FOLEY CATHETER BALLOON (mechanical, safest with a scarred uterus); hygroscopic dilators. MEMBRANE SWEEPING at term reduces the need for formal induction.**
- **After ripening: AMNIOTOMY plus an OXYTOCIN infusion, aiming for ≤5 contractions in 10 minutes with continuous fetal monitoring.**
...
**PEARL:** **The purpose of tocolysis is NOT to prolong pregnancy indefinitely but to BUY 48 HOURS — enough for ANTENATAL CORTICOSTEROIDS to act and for IN-UTERO TRANSFER.** **RITODRINE (β2-agonist) causes maternal TACHYCARDIA, tremor, HYPERGLYCAEMIA (not hypoglycaemia), hypokalaemia, hypocalcaemia, hypomagnesaemia and — the dangerous one — PULMONARY OEDEMA;** the maternal hyperglycaemia then drives fetal hyperinsulinaemia, so **the NEONATE develops HYPOGLYCAEMIA.**

**UNDERSTAND:** All the β-agonist effects are simply **β2 stimulation outside the uterus**: on heart and vessels → tachycardia and vasodilatation; on liver and muscle → **glycogenolysis and gluconeogenesis (hyperglycaemia)** and **potassium driven into cells (hypokalaemia)**. **Pulmonary oedema comes from fluid retention, tachycardia and increased capillary permeability — much more likely with concurrent corticosteroids, multiple pregnancy and excessive IV fluids**, hence strict fluid balance.

**MUST KNOW:**

- **First-line agents now: NIFEDIPINE (calcium channel blocker — cheap, oral, effective; do not combine with magnesium) and ATOSIBAN (oxytocin receptor antagonist — best side-effect profile, expensive). INDOMETHACIN works below 32 weeks but risks PREMATURE CLOSURE OF THE DUCTUS ARTERIOSUS and OLIGOHYDRAMNIOS. β-agonists are largely abandoned.**
- **CONTRAINDICATIONS to tocolysis: chorioamnionitis, severe pre-eclampsia/eclampsia, significant APH or abruption, intrauterine death or lethal anomaly, non-reassuring fetal status, advanced cervical dilatation.**
- **ANTENATAL CORTICOSTEROIDS: betamethasone 12 mg × 2 (24 h apart) or dexamethasone 6 mg × 4 (12-hourly), between 24 and 34 weeks (up to 36 in selected cases)** — they reduce **RDS, INTRAVENTRICULAR HAEMORRHAGE, NECROTISING ENTEROCOLITIS and NEONATAL DEATH**. Maximum benefit **24 hours to 7 days** after the course.
- **MAGNESIUM SULPHATE below 32 weeks is for FETAL NEUROPROTECTION (reducing cerebral palsy), not primarily as a tocolytic.**
...
### 70. Rupture of Membranes — Diagnosis and PPROM Management

**PEARL:** **Amniotic fluid pH is 7.1–7.3 (ALKALINE); normal vaginal secretions are ACIDIC at 4.5–5.5.** On rupture the vaginal pH rises to **6.0–6.5**, turning **NITRAZINE paper from yellow to BLUE**.

**UNDERSTAND:** The vagina is kept acidic by **lactobacilli fermenting glycogen to lactic acid**, and the test measures the loss of that acidity — which immediately predicts the **FALSE POSITIVES: anything alkaline in the vagina — BLOOD, SEMEN, urine, antiseptics, soap, and BACTERIAL VAGINOSIS (lactobacilli already depleted, pH already >4.5).** False negatives occur with prolonged leakage and minimal residual fluid.

**MUST KNOW:**

- **Diagnosis is by STERILE SPECULUM EXAMINATION showing liquor pooling in the posterior fornix — the most reliable sign. DIGITAL VAGINAL EXAMINATION MUST BE AVOIDED** (it introduces infection and shortens latency) unless she is in labour.
- **FERNING: amniotic fluid dried on a slide crystallises in an arborising pattern** (high sodium chloride and protein); blood and meconium reduce reliability. **Modern tests: IGFBP-1 (Actim PROM) and PAMG-1 (AmniSure)** — unaffected by blood, semen or urine.
- **PROM = rupture before labour at any gestation; PPROM = preterm prelabour rupture, before 37 weeks.** The dominant risk in both is **ASCENDING INFECTION (chorioamnionitis)**; in PPROM add prematurity, **cord prolapse** and **pulmonary hypoplasia** with prolonged oligohydramnios.
- **PPROM management: ADMIT; ANTENATAL CORTICOSTEROIDS; LATENCY ANTIBIOTICS — ERYTHROMYCIN, NOT co-amoxiclav (which increases NECROTISING ENTEROCOLITIS — the ORACLE trial); magnesium sulphate for neuroprotection below 32 weeks; monitor for chorioamnionitis; DELIVER AT 34–37 WEEKS or sooner if infection supervenes. TOCOLYSIS IS GENERALLY NOT USED.**
- **CHORIOAMNIONITIS: maternal fever, maternal AND fetal TACHYCARDIA, uterine tenderness, offensive liquor, leucocytosis — broad-spectrum antibiotics and DELIVER, regardless of gestation.**
- **At term with PROM, INDUCTION reduces chorioamnionitis without increasing caesarean rates (the TERMPROM trial).**
...
**PEARL:** **RUPTURED MEMBRANES is a contraindication to cerclage.** The full list: **ruptured membranes, INTRAUTERINE INFECTION, active CONTRACTIONS/labour, VAGINAL BLEEDING, CERVICAL DILATATION >4 cm, and fetal death or lethal anomaly.** **PROLAPSING (bulging) MEMBRANES are NOT an absolute contraindication** — a rescue cerclage may still be attempted.

**UNDERSTAND:** Each contraindication marks a situation where the stitch **either cannot help or actively harms**. With ruptured membranes or infection, a suture **traps infection inside the uterus and converts a preterm delivery into maternal sepsis**. With established contractions or bleeding, the process is already irreversible and the suture simply **tears through the cervix**. The stitch treats a **mechanical failure of a quiet cervix**, nothing else.

**MUST KNOW:**

- **CERVICAL INSUFFICIENCY: recurrent PAINLESS mid-trimester dilatation with painless expulsion — the absence of pain and contractions is the diagnostic hallmark**, distinguishing it from preterm labour. Risks: previous mid-trimester loss, cervical surgery (LEEP, cone biopsy), repeated dilatation, DES exposure, congenital uterine anomalies.
- **Types: ELECTIVE/history-indicated at 12–14 weeks; ULTRASOUND-INDICATED for a cervical length <25 mm before 24 weeks with a relevant history; RESCUE/emergency for dilatation with bulging membranes.** **McDONALD** (simple purse-string, easily removed) and **SHIRODKAR** (submucosal, with bladder dissection) are vaginal; **TRANSABDOMINAL** cerclage (which mandates caesarean delivery) is for failed vaginal cerclage or an absent/very short cervix.
...
### 75. Active Management of the Third Stage

**PEARL: **The WHO components are:** (1) a UTEROTONIC within 1 minute of delivery (OXYTOCIN 10 IU IM is the drug of choice), (2) CONTROLLED CORD TRACTION with counter-traction on the uterus, and (3) assessment of uterine tone.** **SUSTAINED UTERINE MASSAGE IS NO LONGER RECOMMENDED** for women given a uterotonic, and **DELAYED cord clamping (1–3 minutes) is standard — early clamping is NOT part of the package.**

**UNDERSTAND:** The **uterotonic is the component that actually prevents haemorrhage — it reduces PPH by about 60%** — while cord traction merely shortens the third stage. **Delayed clamping allows a placental transfusion that raises neonatal haemoglobin and iron stores for months and reduces intraventricular haemorrhage and necrotising enterocolitis in preterm babies**, with no increase in maternal bleeding.

**MUST KNOW:**

- **EARLY CORD CLAMPING IS INDICATED only when the baby needs IMMEDIATE RESUSCITATION (a NON-VIGOROUS/asphyxiated baby), in severe fetomaternal haemorrhage or abruption/praevia with maternal haemorrhage, and in monochorionic twins with suspected TTTS.** **Rh-negative mothers, pre-eclampsia and prematurity are NOT indications** — preterm babies benefit most from delayed clamping.
- **UMBILICAL CORD MILKING is an alternative when delayed clamping is not possible, but is AVOIDED BELOW 28 WEEKS** because of intraventricular haemorrhage.
...
**PEARL:** The cry of the fetus **inside the uterus** — a rare event that requires **rupture of the membranes with entry of air**.

**REMEMBER:** *No air, no cry.*

---

## Operative Obstetrics

### 78. Caesarean Section — Position, Incisions and Perioperative Care

**PEARL:** The woman is placed **SUPINE WITH A WEDGE UNDER THE RIGHT HIP, giving a 15° LEFT LATERAL TILT** — displacing the uterus off the inferior vena cava and aorta and preventing **SUPINE HYPOTENSION SYNDROME**.

**UNDERSTAND:** From about 20 weeks the **gravid uterus compresses the IVC when the woman lies flat**, cutting venous return by up to 30% and dropping cardiac output — hypotension, nausea, pallor and fetal compromise. The **uterus is normally DEXTRO-ROTATED**, so tilting LEFT rolls it off the great vessels. **Manual left uterine displacement is at least as effective as a wedge** and is what is used during resuscitation.

**MUST KNOW:**

- **ABDOMINAL INCISIONS: JOEL-COHEN — the straight incision 3 cm below the line joining the ASIS, with blunt extension (the Misgav-Ladach technique) — the caesarean incision of choice. PFANNENSTIEL — the classic curved suprapubic. MAYLARD — transverse, cutting the rectus muscles transversely. CHERNY — a gynaecological transverse muscle-cutting incision (rectus detached from the symphysis) for wider pelvic access.**
...
**PEARL:** A **PERIMORTEM CAESAREAN uses a CLASSICAL (UPPER SEGMENT, VERTICAL) uterine incision, is performed AT THE SITE OF THE ARREST — NOT in theatre — and is BEGUN WITHIN 4 MINUTES of arrest with delivery by 5 MINUTES.** It is performed **PRIMARILY TO SAVE THE MOTHER.**

**UNDERSTAND: **The rationale is haemodynamic, not obstetric:** the gravid uterus obstructs the IVC and aorta, so effective CPR is impossible while it remains in place** — delivering it restores venous return and cardiac output and relieves diaphragmatic splinting. A **classical vertical incision gives the fastest access without bladder dissection or a lower-segment flap**; no anaesthesia, no antisepsis, no transfer — moving the patient wastes the only minutes that matter.
...
### 80. Episiotomy and Perineal Tears

**PEARL:** In a **MEDIOLATERAL EPISIOTOMY the structures cut are: posterior vaginal wall, SUPERFICIAL and DEEP TRANSVERSE PERINEAL muscles, BULBOSPONGIOSUS, part of the LEVATOR ANI, the overlying fascia, and the transverse perineal branches of the PUDENDAL vessels and nerves.** **The OBTURATOR muscle is NOT cut** — it lies on the lateral pelvic wall, far from the perineum.

**UNDERSTAND:** The mediolateral incision runs **downwards and outwards from the midpoint of the fourchette at about 60° from the midline**, precisely to **direct it AWAY from the anal sphincter and rectum**. That single geometric decision explains its trade-offs — **less sphincter injury, but more bleeding, more pain and poorer healing** — and why episiotomy scissors are **angulated**.
...
**PEARL:** **VENTOUSE IS ABSOLUTELY CONTRAINDICATED in PRETERM (<34 weeks), FACE PRESENTATION, the AFTER-COMING HEAD OF A BREECH, and INTRAUTERINE FETAL DEATH** (and in suspected fetal coagulopathy). **FORCEPS is the instrument of choice in all of these.** **OUTLET FORCEPS: the scalp is VISIBLE AT THE INTROITUS WITHOUT SEPARATING THE LABIA, the head is ON THE PERINEUM, rotation ≤45°.** **LOW: station ≥+2 but not on the pelvic floor. MID: head engaged but station above +2. HIGH forceps (unengaged head) IS OBSOLETE.**

**UNDERSTAND:** The vacuum applies traction to the fetal **SCALP**, so it needs a **firm, ossified skull and a vertex to grip** — a preterm skull is too compressible, a face has no application point, and the after-coming head needs **controlled immediate delivery with flexion (PIPER FORCEPS)**. Forceps instead **grip the fetal BONES and transmit force to the skull as a whole.** The station classification is a **risk ladder**: the higher the station and the greater the rotation, the more force transmitted and the greater the trauma — which is why outlet forceps is a safe assist, mid-cavity demands an experienced operator with theatre back-up, and high forceps was abandoned once safe caesarean existed.
...
### 83. Postpartum Haemorrhage — Causes and Stepwise Management
...
**PEARL:** **SECONDARY PPH = excessive bleeding between 24 HOURS AND 12 WEEKS after delivery.** Causes: **RETAINED PLACENTAL TISSUE (a retained cotyledon or PLACENTAL POLYP), ENDOMETRITIS, SUBINVOLUTION of the placental site, caesarean scar dehiscence or uterine artery pseudoaneurysm, and rarely gestational trophoblastic disease.** **PLACENTA PRAEVIA causes ANTEPARTUM and PRIMARY PPH — NEVER secondary PPH.** **PUERPERAL PYREXIA = temperature >100.4 °F (38 °C) on any 2 of the first 10 days postpartum, EXCLUDING THE FIRST 24 HOURS.**

**UNDERSTAND: **The distinction is mechanistic:** PRIMARY PPH is failure of the immediate haemostatic mechanisms (the 4 Ts), while SECONDARY PPH is failure of the placental site to INVOLUTE.** Normally the placental bed thromboses, necroses and re-epithelialises over weeks; **retained tissue or infection prevents that**, so the vessels stay open and bleed days later.

**MUST KNOW:**

- **Assessment: ultrasound for retained products (echogenic material is common and non-specific), high vaginal swab and blood cultures, FBC and coagulation, and β-hCG if trophoblastic disease is possible.**
...
### 85. Acute Uterine Inversion

**PEARL:** Profuse PPH with a **mass protruding through the introitus and NO PALPABLE FUNDUS abdominally**, after **cord traction before placental separation**, is **ACUTE UTERINE INVERSION**. Management: resuscitate, attempt **immediate manual repositioning (JOHNSON manoeuvre)**, give **TOCOLYTICS if the ring has clamped down — and do NOT remove the placenta until the uterus is replaced.**

**UNDERSTAND:** Two rules explain everything. First, the placenta is temporarily **plugging the bleeding surface**, so detaching it before replacement converts a controllable situation into torrential haemorrhage. Second, once the ring contracts around the inverted fundus, replacement becomes mechanically impossible — so you need **relaxation, not more force**. Only after the uterus is back inside do you reverse the logic and give **oxytocics** to keep it there. The **shock is out of proportion to blood loss** because it is vagal/neurogenic, from traction on the infundibulopelvic ligaments.
...
- **Prevention: active management of the third stage with controlled cord traction and counter-pressure (BRANDT–ANDREWS) — never traction on an uncontracted uterus.**
...
**PEARL:** Immediately after delivery the uterus weighs **~1000 g and corresponds to a 20-WEEK size**, just below the umbilicus. **1 WEEK — 500 g; 2 WEEKS — it becomes a PELVIC ORGAN (300 g, no longer palpable abdominally); 4 WEEKS — involution clinically complete (100 g); 6–8 WEEKS — pre-pregnant weight ~60 g.**

**UNDERSTAND:** Involution occurs by **a reduction in the SIZE of individual myocytes (autolysis and protein catabolism), NOT by a fall in their NUMBER** — the extra muscle cells shrink rather than disappear. Hence involution is **rapid, complete and repeatable across pregnancies**; it is **accelerated by breastfeeding (oxytocin)** and delayed by retained products, infection, fibroids and a full bladder.

**MUST KNOW:**

- **SUBINVOLUTION — a uterus larger and softer than expected, with persistent or offensive lochia — is caused by RETAINED PRODUCTS, ENDOMETRITIS, fibroids, a full bladder or a retroverted uterus.** It is a leading cause of **secondary PPH**.
- **LOCHIA: RUBRA (red, days 1–4) → SEROSA (pale/pink, days 5–9) → ALBA (whitish, days 10 onwards); total duration on average 24–36 days.** **Offensive odour = infection; persistent rubra = retained products.**
- **AFTER-PAINS** — painful uterine contractions during breastfeeding, commoner in **multiparae**, due to oxytocin release.
- **Other puerperal changes: a DIURESIS in the first week, a physiological leucocytosis, and a persisting HYPERCOAGULABLE state making the puerperium the peak time for VTE.**
...
**PEARL:** **PPH followed by HYPOTENSION UNRESPONSIVE TO FLUIDS, tachycardia, HYPOGLYCAEMIA, headache, visual disturbance and collapse = SHEEHAN SYNDROME (postpartum pituitary necrosis).** The life-saving treatment is **GLUCOCORTICOIDS (hydrocortisone) FIRST**, then thyroxine and other replacement.

**UNDERSTAND:** The anterior pituitary **doubles in size in pregnancy (lactotroph hyperplasia) while its blood supply — the low-pressure hypophyseal PORTAL system — does not keep pace**, leaving it uniquely vulnerable to hypotension. Severe haemorrhage **infarcts the anterior lobe**, sparing the posterior (which has a direct arterial supply) — so **diabetes insipidus is uncommon**. Cortisol deficiency explains the whole acute picture: **fluid- and pressor-resistant hypotension, hypoglycaemia and hyponatraemia.**
...
- **Screen: infants of DIABETIC mothers, LARGE-for-gestational-age and macrosomic babies, SMALL-for-gestational-age and growth-restricted babies (low glycogen stores), PRETERM infants, and those with perinatal asphyxia, hypothermia, sepsis or polycythaemia, and infants of mothers on beta-blockers.**
...
- **Five classic sites of ureteric injury: (1) at the PELVIC BRIM near the infundibulopelvic ligament (ligating ovarian vessels); (2) in the OVARIAN FOSSA; (3) where the UTERINE ARTERY crosses it — the COMMONEST site, during clamping of the cardinal ligament; (4) at the UTEROSACRAL ligament; (5) near the BLADDER/vaginal angle.**
- **The ureter is ~25 cm long with THREE physiological constrictions — the pelvi-ureteric junction, the crossing of the iliac vessels at the brim, and the vesico-ureteric junction (the narrowest).**
- **Prevention: identify it early, stay close to the uterus when clamping, avoid blind clamping in bleeding fields, and consider preoperative stenting in difficult cases (endometriosis, large fibroids, malignancy, previous surgery, frozen pelvis).**
- **Missed injury presents with flank pain and fever, ILEUS, urinoma, ascites and a rising creatinine, or a watery vaginal discharge (ureterovaginal fistula) days later.** Diagnose by **CT urography or retrograde pyelography**.
- **Repair by level: LOWER third → URETERONEOCYSTOSTOMY (with a Boari flap or psoas hitch if needed); MID/UPPER third → ureteroureterostomy over a stent.**
- **Bladder injury recognised at operation is repaired in layers immediately with prolonged catheter drainage** — recognition at the time is what determines outcome for both organs.

**EXAM CONNECTION:** Structure identification → **glistening, peristalses on stimulation, uterine artery crosses above it**.
...
**PEARL:** The **OVARIAN LIGAMENT lies in the POSTERIOR fold**; the **ureter runs in the inferomedial part**, crossed above by the uterine artery. **The BROAD LIGAMENT IS NOT A SUPPORT of the uterus.**

**UNDERSTAND:** The broad ligament is only a **double fold of peritoneum draped over the tube, round ligament and ovarian ligament** — it has no fibromuscular strength. The true supports are fibromuscular condensations of pelvic fascia plus the muscular floor beneath.
...
### 93. Peg Cells and the Fallopian Tube
...
**UNDERSTAND: **The tube needs both:** ciliated cells sweep the ovum toward the uterus** and **peg cells secrete the nutrient fluid** that sustains the ovum and capacitates sperm. Both are **oestrogen-dependent** and vary through the cycle — ciliated cells predominate at ovulation.

**MUST KNOW:**

- **The AMPULLA is the site of fertilisation**, with the most abundant ciliation and the most complex mucosal folds (**plicae**).
...
- **CENTRAL (true, GnRH-dependent): LH and FSH HIGH/pubertal with a pubertal response to a GnRH stimulation test; ISOSEXUAL and in NORMAL SEQUENCE (thelarche → pubarche → growth spurt → menarche). Most cases in girls are IDIOPATHIC, but MRI BRAIN is mandatory to exclude a hypothalamic HAMARTOMA, glioma, hydrocephalus or previous CNS insult. Treat with a GnRH AGONIST (continuous, desensitising the pituitary).**
- **PERIPHERAL (pseudo, GnRH-independent): LH and FSH SUPPRESSED. Causes — McCune–Albright, ovarian follicular cysts and GRANULOSA CELL TUMOURS, adrenal tumours, CAH, exogenous oestrogen, and severe primary HYPOTHYROIDISM (VAN WYK–GRUMBACH syndrome, where very high TSH cross-reacts with the FSH receptor — the ONE form with DELAYED, not advanced, bone age).**
...
**PEARL:** **MENOPAUSE = 12 CONSECUTIVE MONTHS of amenorrhoea — a RETROSPECTIVE, clinical diagnosis** requiring no hormone assay. Average age ~50 (45–55). **PREMATURE OVARIAN INSUFFICIENCY = before 40.** The **CLIMACTERIC** is the whole transition of waning ovarian activity, beginning **2–3 years before** and continuing **2–5 years after** menopause.

**UNDERSTAND:** The 12-month rule exists because **the perimenopause is erratic and unpredictable** — cycles may cease for months then resume, and FSH can be menopausal one month and normal the next. Only sustained amenorrhoea proves **complete follicular depletion**. The practical corollary: **contraception must continue for 12 months after the last period if over 50, and for 2 YEARS if under 50**, because sporadic ovulation still occurs.
...
- **Timeline: OOGONIA multiply by mitosis in fetal life, peaking at ~6–7 MILLION at 20 weeks; ~1–2 MILLION at BIRTH (all arrested in prophase I); ~400,000 at PUBERTY; only ~400 ever ovulate. NO NEW OOCYTES ARE FORMED AFTER BIRTH — the opposite of spermatogenesis.**
- **Each female meiotic division is UNEQUAL, conserving cytoplasm in one cell and discarding the rest as POLAR BODIES — so one primary oocyte yields ONE ovum (versus four spermatozoa).**
...
- **FERTILISATION in the AMPULLA. Sperm must undergo CAPACITATION in the female tract (~6–8 hours) then the ACROSOME REACTION; ZP3 on the zona pellucida is the sperm receptor, and the CORTICAL REACTION blocks polyspermy.**
...
### 98. Cervical Mucus Ferning, Vaginal Cytology and Ovulation Markers

**PEARL:** **FERNING (arborisation) of cervical mucus indicates a high-OESTROGEN, PRE-OVULATORY state** — and vaginal cytology in the same phase shows **SUPERFICIAL CELL PREDOMINANCE** (acidophilic pink cells with small pyknotic nuclei). **SUBNUCLEAR VACUOLATION is the histological hallmark of the EARLY SECRETORY phase — the first morphological evidence that OVULATION has occurred** (day 16–17, 36–48 h after ovulation).

**UNDERSTAND:** Ferning and cytology measure the **same hormone through different tissues**. Oestrogen makes cervical mucus **copious, thin, watery and rich in sodium chloride**, so on drying the salt crystallises into a fern — and that same thin mucus admits sperm (**spinnbarkeit** stretching to 10 cm at ovulation). Oestrogen simultaneously drives the vaginal epithelium to **mature fully to superficial cells**. **Progesterone does the opposite**: mucus becomes **thick, scanty and cellular (no ferning)** and maturation halts at **intermediate cells** — while in the endometrium it produces the subnuclear vacuoles.

**MUST KNOW:**

- **Vaginal cytology as a hormonal assay: SUPERFICIAL cells = OESTROGEN (proliferative phase, ovulation, oestrogen-secreting tumours); INTERMEDIATE cells (basophilic, navicular in pregnancy) = PROGESTERONE (secretory phase, pregnancy); PARABASAL and BASAL cells = NO hormonal stimulation (menopause, prepuberty, lactation, hypogonadism).** The **maturation index** is their ratio.
...
**REMEMBER:** *Oestrogen makes the mucus fern and the vaginal cells mature to the surface; vacuoles under the nuclei mean ovulation has happened.*
...
### 99. Evaluating Amenorrhoea by Gonadotrophins

**PEARL:** **HIGH FSH and LH = HYPERGONADOTROPHIC HYPOGONADISM = OVARIAN FAILURE** — the next step is **SERUM OESTRADIOL** (and karyotype). **Raised gonadotrophins also EXCLUDE PREGNANCY**, because pregnancy suppresses FSH and LH. **LOW FSH/LH = HYPOGONADOTROPHIC (hypothalamic–pituitary). NORMAL FSH/LH = EUGONADOTROPHIC (outflow tract or PCOS).**

**UNDERSTAND:** FSH and LH are the **read-out of the negative feedback loop**. If the ovary fails, oestradiol falls, feedback is lost and gonadotrophins rise — so **high FSH localises the lesion to the GONAD**. If the hypothalamus or pituitary fails, there is nothing to drive the ovary, so **both gonadotrophins and oestradiol are low**. One hormone pair localises the level of the defect before any imaging.
...
### 105. Uterine Leiomyoma

**PEARL:** **MULTIPLE WELL-CIRCUMSCRIBED, FIRM, GREY-WHITE NODULES with a WHORLED CUT SURFACE = LEIOMYOMA (fibroid)** — the commonest benign tumour and the commonest pelvic tumour in women. **INTRAMURAL is the commonest type; SUBMUCOUS is the most SYMPTOMATIC** (menorrhagia, infertility, recurrent miscarriage) despite being the least common; **SUBSEROSAL** causes pressure effects and may become **pedunculated or parasitic**.

**UNDERSTAND:** The **whorled appearance is the histology made visible** — interlacing bundles of smooth muscle and fibrous tissue. The **sharp circumscription reflects a compressed PSEUDOCAPSULE of surrounding myometrium** (not a true capsule), which is exactly what permits **enucleation at myomectomy**. Fibroids are **OESTROGEN- and PROGESTERONE-DEPENDENT** — hence growth in the reproductive years and in pregnancy, and **regression after menopause**, the fact that governs both medical treatment and expectant management.
...
**REMEMBER:** *Firm, white, whorled and shelling out cleanly — and it shrinks after menopause.*
...
- **Other causes of a nodular pouch of Douglas — TUBERCULOSIS and disseminated MALIGNANCY — must be considered, especially in India.**

**EXAM CONNECTION:** Nodularity in the pouch of Douglas → **endometriosis**.

**REMEMBER:** *Retrograde menstruation lands in the pouch of Douglas — feel for the nodules while she is bleeding; and a painful scar lump that swells with periods gets excised.*
...
**PEARL:** The most specific MRI sign is **JUNCTIONAL ZONE THICKENING ≥12 mm** (normal <8 mm; 8–12 mm equivocal), with a globular uterus and myometrial cysts. Clinically: a **multiparous woman in her 40s with menorrhagia, PROGRESSIVE dysmenorrhoea and a symmetrically enlarged, boggy, TENDER uterus.**

**UNDERSTAND:** The junctional zone is the **inner myometrium** — exactly where endometrial glands invade. On T2-weighted MRI it is normally a **thin dark band** (compact, low-water-content smooth muscle); invasion causes **hyperplasia of that inner layer**, thickening it and studding it with **bright cystic foci** (trapped glands and haemorrhage). The sign is a direct picture of the pathology, which is why it is the most specific criterion.
...
### 110. Ovarian Dermoid (Mature Cystic Teratoma)

**PEARL:** The **commonest benign ovarian tumour in the reproductive age group**. It is also the **commonest GERM CELL tumour**, **BILATERAL in 10–15%**, the **commonest ovarian tumour diagnosed IN PREGNANCY**, and the **tumour most likely to undergo TORSION**.
...
### 111. Cervical Screening, Cytology Classification and the Abnormal Smear
...
**PEARL:** **HIGH-RISK (oncogenic): 16, 18, 31, 33, 45, 52, 58.** **LOW-RISK (warts): 6 and 11.** **Nonavalent Gardasil-9 covers 6, 11, 16, 18, 31, 33, 45, 52, 58.**
...
- **CERVARIX — bivalent (16, 18), at 0, 1, 6 months. GARDASIL / CERVAVAC — quadrivalent (6, 11, 16, 18), at 0, 2, 6 months. GARDASIL-9 — nonavalent**, also covering vulvar/vaginal/anal intraepithelial neoplasia and oropharyngeal and head-and-neck cancers.
...
- **16 and 18 together cause ~70% of cervical cancers; 16 is commonest in SQUAMOUS carcinoma, 18 in ADENOCARCINOMA.**
- **Cervical cancer does NOT run in families** — the daughter of an affected woman needs **vaccination and routine screening**, not genetic testing or biopsy.
- **HPV DNA detection: PCR, hybrid capture, Southern blot.**
...
### 113. Cervical Cancer — FIGO Staging and Treatment by Stage

**PEARL:** **HYDRONEPHROSIS or a non-functioning kidney = FIGO STAGE IIIB**, regardless of tumour size. **Positive pelvic nodes = IIIC1; para-aortic nodes = IIIC2** — nodal disease is **NOT** M1. **PARAMETRIAL INVOLVEMENT (IIB) IS THE CUT-OFF FOR SURGERY: IA–IB2/IIA1 → radical hysterectomy; IIB and above → CONCURRENT CHEMORADIATION with cisplatin.**

**UNDERSTAND:** Hydronephrosis is taken as **proof of pelvic sidewall involvement** — the ureter is compressed as it crosses the pelvic brim — so the system upgrades on that **functional finding alone**, without needing to demonstrate tumour touching the wall. It is a rare instance of a physiological consequence defining a stage.
...
- **Stage IA1 (≤3 mm, no LVSI) can be treated by CONISATION ALONE if fertility is desired, or simple hysterectomy. RADICAL TRACHELECTOMY (cervix, upper vagina and parametrium with a cerclage, preserving the uterine body) is the fertility-sparing option for small early tumours.**
- **RADIOTHERAPY is indicated for node-positive stage I, node-positive stage II, and ALL stage III and IV. Surgery and radiotherapy give equal survival in early stage IB — AVOID COMBINING BOTH (fistula, stenosis).**
...
### 115. Radiotherapy Points A and B in Cervical Cancer

**PEARL:** **POINT A is 2 cm SUPERIOR to the external os (along the uterine canal) and 2 cm LATERAL to it — approximating the crossing of the URETER AND UTERINE ARTERY — and receives ~7000 cGy.** **POINT B is 3 cm LATERAL TO POINT A (5 cm from the midline) at the same level — approximating the PELVIC SIDE WALL/obturator nodes — and receives ~6000 cGy.**

**UNDERSTAND:** These reference points exist because **intracavitary brachytherapy delivers a steeply falling dose**, so the prescription must be anchored to defined anatomical points rather than the source. **Point A represents the PARACERVICAL tissue (medial parametrium)** — the dose there determines local control and also the dose to the ureter and bladder base, which limits toxicity. **Point B represents the LATERAL PARAMETRIUM AND NODES**, the region treated by external beam.

**MUST KNOW:**

- **From stage IB3/IIB onwards: CONCURRENT CHEMORADIATION — external beam plus WEEKLY CISPLATIN (a radiosensitiser) plus INTRACAVITARY BRACHYTHERAPY (tandem and ovoids). BRACHYTHERAPY IS ESSENTIAL — omitting it worsens survival.**
- **Modern practice uses IMAGE-GUIDED (MRI-based) volumetric planning, but points A and B remain the classical examinable landmarks (the MANCHESTER system; Stockholm and Paris are the other historical schemes).**
...
- **Causes in order: atrophic vaginitis/endometritis (~60%), exogenous OESTROGEN/HRT and TAMOXIFEN (~15–20%), ENDOMETRIAL CANCER (~10%), endometrial or cervical POLYPS (~5%), hyperplasia, cervical carcinoma, and rarely an oestrogen-secreting GRANULOSA CELL TUMOUR or a bleeding disorder.**
- **A thickness ≤4 mm has a negative predictive value >99% for cancer — but ANY persistent or recurrent bleeding still warrants biopsy, and HYSTEROSCOPY if bleeding persists or the biopsy is inadequate, since focal lesions are missed by blind sampling.** Other suspicious ultrasound features: an **irregular hyperechoic endometrium, increased LOW-RESISTANCE vascularity, intrauterine fluid**.
- **Normal thickness for comparison: ~11 mm at ovulation (day 14); 1–2 mm in the early proliferative phase. In IVF, an endometrium <7 mm at ovulation predicts poor implantation.**
- **TAMOXIFEN is an antagonist in the breast but a PARTIAL AGONIST in the endometrium — it increases polyps, hyperplasia and CARCINOMA (2–3-fold) and raises VTE risk. RALOXIFENE is an antagonist in the endometrium too and does NOT increase endometrial cancer.** **Investigate ANY bleeding on tamoxifen promptly, but routine ultrasound surveillance of asymptomatic users is NOT recommended** — tamoxifen causes subendometrial cystic change mimicking thickening, so **the 4 mm rule does not apply**; investigate on **symptoms**.
- **HYPERPLASIA: without atypia — low progression risk, treat with progestogens (LNG-IUS first-line). WITH ATYPIA (endometrioid intraepithelial neoplasia) — 25–40% harbour or progress to carcinoma; HYSTERECTOMY is standard, with high-dose progestogen only for fertility preservation under close surveillance.**
...
### 117. Endometrial Carcinoma — Types and FIGO Staging

**PEARL:** **>50% MYOMETRIAL INVASION = STAGE IB.** **POSITIVE PERITONEAL WASHINGS and LYMPHOVASCULAR SPACE INVASION DO NOT CHANGE THE FIGO STAGE** — washings were removed in the 2009 revision.

**UNDERSTAND:** FIGO stages by **anatomical extent of tumour spread**, not by cytological or microvascular findings. Washings were dropped because positive cytology alone had no independent effect on survival once depth and grade were accounted for. **LVSI is a powerful PROGNOSTIC factor guiding ADJUVANT THERAPY, but it is not a compartment the tumour has physically invaded** — so it stays out of the stage.

**MUST KNOW (FIGO 2009, the version most examined — see the 2023 revision below):**

- **IA — no or <50% myometrial invasion; IB — ≥50%.**
...
- **TYPE I (~80%): ENDOMETRIOID, OESTROGEN-DEPENDENT, arising in ATYPICAL HYPERPLASIA, in younger/perimenopausal obese women — risk factors are UNOPPOSED OESTROGEN, obesity, nulliparity, PCOS, late menopause, early menarche, diabetes, TAMOXIFEN and LYNCH SYNDROME; PTEN, KRAS and microsatellite instability; low grade, GOOD prognosis.**
- **TYPE II (~10–20%): SEROUS and CLEAR CELL, OESTROGEN-INDEPENDENT, older thin women with an ATROPHIC endometrium, p53 mutation, deeply invasive with early spread — POOR prognosis, behaving like ovarian cancer.**
- **It is the commonest gynaecological malignancy in developed countries; ~90% present with POSTMENOPAUSAL BLEEDING, hence usually diagnosed EARLY (stage I) with a good prognosis.**
- **Staging is SURGICAL: total hysterectomy + BSO + peritoneal washings + nodal assessment (increasingly SENTINEL node); adjuvant vaginal brachytherapy or EBRT by grade, depth and LVSI.**

**EXAM CONNECTION:** The stem loads the stage-irrelevant findings (**LVSI, positive washings**) to tempt you into Stage III. Anchor on **depth of myometrial invasion**.

**FIGO 2023 REVISION (increasingly asked):** **Staging is no longer purely anatomical — HISTOLOGICAL TYPE, GRADE, SUBSTANTIAL LVSI and MOLECULAR SUBTYPE now enter the stage.** **Complete molecular classification into POLEmut, MMRd, NSMP and p53abn is encouraged in every endometrial cancer**, recorded as an **“m” subscript on the stage**. In **early disease this re-stages the tumour: POLEmut Stage I–II becomes STAGE IAm(POLEmut) — excellent prognosis, de-escalate treatment; p53abn Stage I–II becomes STAGE IICm(p53abn) — aggressive, escalate.** **Non-aggressive histology confined to a polyp or to the endometrium = IA1; aggressive histology or substantial LVSI upstages within Stage I–II.**[^4]

**REMEMBER:** *Half the myometrium makes it IB; washings and LVSI change the treatment, not the stage — except under FIGO 2023, where substantial LVSI and the molecular subtype change the stage itself.*
...
- **STAGE III (beyond the pelvis to peritoneum and/or retroperitoneal nodes): IIIA1 — POSITIVE RETROPERITONEAL NODES ONLY [(i) ≤10 mm, (ii) >10 mm]. IIIA2 — MICROSCOPIC extrapelvic peritoneal involvement ± nodes. IIIB — MACROSCOPIC peritoneal deposits ≤2 cm ± nodes. IIIC — macroscopic deposits >2 cm ± nodes** (includes extension to the **capsule** of liver or spleen without parenchymal invasion).
- **STAGE IV: IVA — MALIGNANT PLEURAL EFFUSION with positive cytology; IVB — parenchymal (liver, spleen) metastases and extra-abdominal organs, INCLUDING INGUINAL and other extra-abdominal nodes.**
...
**PEARL:** The panel is **CA-125 (epithelial, especially serous), LDH (DYSGERMINOMA), AFP (YOLK SAC/endodermal sinus tumour and embryonal carcinoma), hCG (CHORIOCARCINOMA, embryonal carcinoma, dysgerminoma with syncytiotrophoblastic cells), CA 19-9 (MUCINOUS tumours and mature teratoma), INHIBIN and AMH (GRANULOSA cell tumour), and CEA (mucinous/metastatic gastrointestinal).**

**UNDERSTAND:** The panel exists because **the ovary gives rise to tumours of THREE different lineages** — surface epithelium, germ cells and sex-cord/stroma — each secreting different products. **A young woman with a solid ovarian mass needs germ-cell markers (AFP, hCG, LDH); a postmenopausal woman with a complex cystic mass and ascites needs CA-125.** Age plus imaging directs which markers matter.

**MUST KNOW:**

- **CA-125 IS NOT A SCREENING TEST** — raised in endometriosis, fibroids, PID, pregnancy, menstruation, cirrhosis, tuberculosis, heart failure and any peritoneal irritation, and **NORMAL in up to 50% of early-stage ovarian cancers**. **RMI = ultrasound score × menopausal score × CA-125; >200 warrants referral to a gynaecological oncologist.**
...
- **YOLK SAC: second commonest malignant ovarian germ cell tumour; peak in the SECOND DECADE; aggressive, unilateral, fast-growing, presenting with pain from torsion/rupture. Treat with fertility-sparing unilateral salpingo-oophorectomy + staging, then BEP (bleomycin, etoposide, cisplatin) — highly chemosensitive, good prognosis.**
...
**REMEMBER:** *The yolk sac made AFP in the fetus, and its tumour still does. Y in a streak gonad breeds gonadoblastoma — take it out.*
...
**PEARL:** The **VIRILISING** ovarian tumour is the **ARRHENOBLASTOMA (SERTOLI–LEYDIG cell tumour)**; the **FEMINISING (oestrogenic)** tumours are the **GRANULOSA CELL TUMOUR and the THECOMA**. **Brenner tumour and carcinoid are neither.** **MEIGS SYNDROME = ovarian FIBROMA + ASCITES + PLEURAL EFFUSION (classically RIGHT-sided), all resolving completely after removing the tumour.**

**UNDERSTAND:** Sex cord–stromal tumours secrete **the hormone of the cell they imitate** — a tumour of **Sertoli and Leydig cells** (male gonadal cell types) makes **androgens** and produces defeminisation then virilisation; a tumour of **granulosa and theca cells** (female follicular cells) makes **oestrogen** and stimulates the endometrium. Recognise the cell of origin and the syndrome follows. In Meigs, the fibroma is a benign, solid, oedematous tumour that **transudates fluid from its surface** into the peritoneum, which then tracks into the chest through **diaphragmatic lymphatics and small fenestrations, more numerous on the right** — nothing is malignant and nothing has metastasised, which is why removal is curative and why it is the classic **benign mimic of ovarian carcinoma** (CA-125 can be raised).
...
### 124. Pseudomyxoma Peritonei

**PEARL:** **Jelly-like mucinous deposits filling the peritoneal cavity**, from rupture of a **mucinous tumour of the OVARY or APPENDIX**.
...
- **It presents LATE, in a postmenopausal woman, with long-standing PRURITUS and a lump or ulcer, most often on the LABIUM MAJUS. ANY persistent vulval lesion or non-healing ulcer must be BIOPSIED** — delay is the rule and the reason for poor outcomes.
- **Spread is LYMPHATIC — superficial then deep INGUINOFEMORAL nodes, then pelvic nodes. NODAL STATUS IS THE SINGLE MOST IMPORTANT PROGNOSTIC FACTOR.** Staging is **SURGICAL (FIGO)**.
...
### 126. Tubal Patency Testing — HSG, Laparoscopy and Hydrosalpinx
...
### 128. Ovarian Hyperstimulation Syndrome

**PEARL:** In a woman on **GONADOTROPHINS, ultrasound showing MULTIPLE ENLARGED FOLLICLES/ENLARGED OVARIES with FREE FLUID = OHSS** — an **IATROGENIC, potentially life-threatening complication TRIGGERED BY hCG** (the ovulation trigger, or the hCG of an ensuing pregnancy).

**UNDERSTAND:** OHSS is a **VEGF-mediated capillary leak syndrome**: luteinised granulosa cells release VEGF under hCG stimulation, massively increasing vascular permeability. Fluid shifts out of the intravascular space into the peritoneum and pleura — producing the paradox that defines the illness: **ASCITES AND OEDEMA WITH INTRAVASCULAR DEPLETION**, hence haemoconcentration, oliguria, hypotension, thrombosis and renal failure in a patient who looks fluid-overloaded.
...
### 129. Azoospermia and Sertoli-Cell-Only Syndrome

**PEARL:** **TESTICULAR BIOPSY distinguishes OBSTRUCTIVE from NON-OBSTRUCTIVE azoospermia** — **NORMAL spermatogenesis in obstruction**, absent or severely reduced in testicular failure. The initial clue: **NORMAL FSH with NORMAL-sized testes → OBSTRUCTION; HIGH FSH with SMALL, soft testes → PRIMARY TESTICULAR FAILURE; LOW FSH and LH → PRE-TESTICULAR (hypogonadotrophic).** A biopsy showing **SEMINIFEROUS TUBULES LINED ONLY BY SERTOLI CELLS with COMPLETE ABSENCE OF GERM CELLS and a thickened basement membrane = SERTOLI-CELL-ONLY (DEL CASTILLO) SYNDROME.**

**UNDERSTAND:** FSH is regulated by **INHIBIN B from Sertoli cells**, so it is effectively **a blood test of seminiferous tubule function**: destroy the germinal epithelium and inhibin falls, so FSH rises. Obstruction leaves the tubules intact, so **FSH stays normal**. In Sertoli-cell-only syndrome the **Leydig cells are unaffected**, so **testosterone and LH are normal and the man is normally virilised** — the only abnormality is infertility. Biopsy is confirmatory because FSH is only a proxy — and has the advantage that **sperm retrieved at the same time can be used for ICSI**.
...
- **Histological patterns: OBSTRUCTIVE — normal complete spermatogenesis. SERTOLI-CELL-ONLY — no germ cells. MATURATION ARREST — germ cells stopping at a stage. HYALINISATION/tubular sclerosis — end-stage, as in Klinefelter.**
...
**PEARL:** **Strict MORPHOLOGY is the single best discriminator of male fertility.** Lower reference limit **>4% normal forms**.
...
- **INFERTILITY = failure to conceive after 12 MONTHS of regular unprotected intercourse — but evaluate EARLIER (6 months) if the woman is over 35, or immediately with obvious pathology (amenorrhoea, known tubal disease, previous chemotherapy, severe male factor).**
- **The three essential tests: SEMEN ANALYSIS, confirmation of OVULATION, TUBAL PATENCY.** Add TVS for ovarian reserve (**antral follicle count, AMH**) and uterine anatomy. **Routine laparoscopy is no longer first-line.**
- **Stepwise escalation: EXPECTANT management with timed intercourse and lifestyle optimisation for 6–12 months in young couples → OVARIAN STIMULATION (clomiphene/letrozole) WITH INTRAUTERINE INSEMINATION for 3–6 cycles → IVF. FEMALE AGE is the single strongest predictor of success at every step.**
- **Ovulation induction: LETROZOLE (aromatase inhibitor — now first-line in PCOS, higher live-birth rates than clomiphene), CLOMIPHENE CITRATE, gonadotrophins, metformin as an adjunct in PCOS. Main risks: MULTIPLE PREGNANCY and OHSS.**
- **Lifestyle is examinable: obesity, smoking, alcohol, excessive caffeine, heat exposure and anabolic steroids all reduce fertility — and correcting them is free.**
...
**EXAM CONNECTION:** Frothy discharge + strawberry cervix → ***Trichomonas vaginalis***. Three vaginitides, three discharges, three pH values.
...
**PEARL:** ***CHLAMYDIA TRACHOMATIS* is the commonest cause of PID**, ahead of gonococcus; PID is usually **polymicrobial**. **GONORRHOEA is the commonest cause of a BARTHOLIN ABSCESS** — acute unilateral painful swelling — and most women with it are **ASYMPTOMATIC**.
...
### 134. The Levator Ani and Pelvic Organ Prolapse

**PEARL:** The **PUBOCOCCYGEUS is the deepest and most important component of the levator ani** — injury to it causes **CYSTOCELE, ENTEROCELE and URETHRAL DESCENT**. The three parts are **PUBOCOCCYGEUS (anterior — with pubovaginalis, puboperinealis and puboanalis), PUBORECTALIS (intermediate) and ILIOCOCCYGEUS (posterior).**

**UNDERSTAND:** The levator ani is **tonically contracted at rest**, holding the urogenital hiatus closed and the pelvic organs on a **horizontal shelf**, so that **intra-abdominal pressure presses them AGAINST the muscle rather than THROUGH it**. Once childbirth stretches or avulses the pubococcygeus from the pubic bone, the hiatus widens and **every rise in intra-abdominal pressure now drives the organs downwards** — which is why prolapse is progressive and presents years after the delivery that caused it.
...
- **Nine measurements: six points — Aa, Ba (anterior wall); C, D (apex — C is the cervix/vaginal cuff, D the posterior fornix, ABSENT after hysterectomy); Ap, Bp (posterior wall) — plus three lengths: genital hiatus (gh), perineal body (pb), total vaginal length (tvl).**
- **Staging: 0 no descent; 1 leading edge >1 cm ABOVE the hymen; 2 leading edge WITHIN 1 cm above or below the hymen; 3 leading edge >1 cm BELOW but not complete eversion; 4 COMPLETE EVERSION (procidentia).** **Stage 2 is the crucial boundary — prolapse reaching the hymen — because symptoms typically begin there.**
- **Support levels (DeLancey): LEVEL 1 — cardinal/uterosacral (apical); LEVEL 2 — arcus tendineus and paravaginal (lateral); LEVEL 3 — perineal body and urogenital diaphragm (distal). LEVEL 1 FAILURE causes apical/uterine and vault prolapse.**

**EXAM CONNECTION:** Diagram identification, then staging. The sign convention is set by **the hymen**, and stage 2 straddles it.
...
- **FIRST-LINE TREATMENT FOR ALL TYPES IS SUPERVISED PELVIC FLOOR (KEGEL) MUSCLE TRAINING for at least 3 months**, with weight loss, smoking cessation, treatment of constipation and cough, and vaginal oestrogen in postmenopausal women. **DULOXETINE is the only useful drug. The surgical gold standard is a MID-URETHRAL SLING (TVT/TOT)** or Burch colposuspension.
- **Distinguish the incontinence types: STRESS — leak on effort, no urge, small volumes. URGE (overactive bladder/detrusor overactivity) — sudden urgency, nocturia, large-volume leaks; treat with bladder training, ANTIMUSCARINICS (oxybutynin, solifenacin — beware dry mouth, constipation and confusion in the elderly), MIRABEGRON, botulinum toxin. MIXED — both. OVERFLOW — chronic retention with dribbling. CONTINUOUS leak WITH normal voiding → FISTULA or an ECTOPIC URETER.**
...
### 139. Mechanisms of Hormonal Contraception

**PEARL:** Combined oral contraceptives act by **INHIBITING GnRH (and thus LH/FSH) release — they do NOT increase GnRH** — plus **thickening cervical mucus** and making the **endometrium unfavourable for implantation**. **PROGESTOGEN-ONLY PILLS work MAINLY by THICKENING CERVICAL MUCUS**, plus inhibiting tubal motility and suppressing ovulation in some cycles — **they do NOT kill sperm** (that is a spermicide).

**UNDERSTAND:** The primary mechanism differs because of what is doing the suppressing. **Oestrogen gives consistent, reliable suppression of the mid-cycle LH surge — so combined pills reliably block OVULATION** (oestrogen suppresses FSH so no dominant follicle forms; progestogen suppresses the LH surge). Progestogen alone suppresses ovulation only inconsistently — except **desogestrel/Cerazette, which inhibits ovulation in ~97% of cycles** — so its dependable action is the **local, immediate effect on cervical mucus**, which also explains the reduced PID rates and the strict timing requirements.

**MUST KNOW:**

- **POPs are the contraceptive of choice for BREASTFEEDING women (no effect on milk) and are SAFE where oestrogen is contraindicated: hypertension, smokers over 35, MIGRAINE WITH AURA, obesity, diabetes with vascular disease, SLE, previous VTE. They do NOT affect clotting, lipid or carbohydrate metabolism.** **The commonest side effect and reason for discontinuation is IRREGULAR BLEEDING.**
...
### 140. Oral Contraceptive Preparations and Missed Pills

**PEARL:** Among Indian preparations **LOETTE has the LEAST oestrogen — ethinyl oestradiol 20 µg with desogestrel; MALA-N, MALA-D and YASMIN all contain 30 µg.** **MALA-N (free, government supply) and MALA-D (subsidised social marketing) both contain LEVONORGESTREL 0.15 mg + EE 30 µg as 21 hormone tablets + 7 IRON tablets.** **ONE OR TWO missed pills at any time: TAKE THEM AT ONCE (up to 2 on the same day) and continue — no extra precaution. THREE OR MORE: take the most recent pill, USE BARRIER PROTECTION FOR 7 DAYS, consider emergency contraception, and if missed in the THIRD WEEK, OMIT THE HORMONE-FREE INTERVAL and start a new pack immediately.**

**UNDERSTAND:** Oestrogen doses have fallen steadily because **oestrogen is responsible for the VTE risk** (it increases clotting factor synthesis) while contributing relatively little extra efficacy — the trade-off for lower doses is **more breakthrough bleeding**. The missed-pill rules exist to protect **the 7-day rule of ovarian suppression**: **7 consecutive active pills are needed to suppress follicular development reliably, and the pill-free week is the point of greatest vulnerability** because the ovary is already 7 days into recovery. So **missing pills adjacent to the hormone-free interval (week 1 or week 3) is the dangerous situation**, and the remedy is to eliminate that interval.

**MUST KNOW:**

- **Generations: 1st — EE ≥50 µg. 2nd — EE 20–35 µg with LEVONORGESTREL or norgestimate. 3rd — EE 20–30 µg with DESOGESTREL or gestodene. 4th — DROSPIRENONE, dienogest, nomegestrol.** **Third- and fourth-generation progestogens carry a HIGHER VTE risk than second-generation levonorgestrel** — counter-intuitive and heavily examined.
...
**REMEMBER:** *Oestrogen carries the clot risk, so the dose fell from fifty to twenty — and seven active pills protect you, so never let a gap fall next to the pill-free week.*
...
**PEARL:** **The COPPER IUCD is the ONLY emergency contraceptive effective up to 5 DAYS (120 hours)** — and the **MOST effective (failure <1%)**. **LEVONORGESTREL 1.5 mg (or 0.75 mg twice, 12 hours apart) is given within 72 hours; ULIPRISTAL ACETATE 30 mg is the one hormonal exception, effective up to 120 hours.**

**UNDERSTAND:** Hormonal methods work by **delaying or preventing OVULATION**, so once ovulation has occurred they are useless — which caps their window at ~72 hours. The copper IUCD works **post-fertilisation**, by a **direct spermicidal effect of copper ions and by preventing implantation** through a sterile inflammatory endometrial reaction — so it still works after ovulation, right up to implantation at day 5–7. **None of these methods disrupts an established (implanted) pregnancy** — an important counselling and ethical point.

**MUST KNOW:**

- **Levonorgestrel efficacy falls with time and with BMI >26–30** — offer **ulipristal or a copper IUCD** in obese women. Ulipristal is a **selective progesterone receptor modulator**, superior to LNG close to ovulation.
- **YUZPE regimen (combined OCP, 2 doses 12 hours apart) within 72 hours — largely obsolete because of vomiting. MIFEPRISTONE low dose is also effective within 72 hours, acting primarily by preventing implantation.**
...
- **Insert the copper IUCD within 5 days of intercourse OR within 5 days of the earliest expected ovulation** — and it then provides **10 years of ongoing contraception**. Avoid in suspected infection, PID or existing pregnancy.
- **Indications: unprotected intercourse, condom rupture, missed pills, a delay >3 hours in a POP, sexual assault.**
...
### 142. Intrauterine Contraceptive Devices

**PEARL:** **NOVA-T contains SILVER added to the copper wire — the silver core prevents copper fragmentation and extends life from 3 to 5 YEARS.** **COPPER T 380A (ParaGard) lasts 10 YEARS (the longest); MIRENA (LNG-IUS, 52 mg levonorgestrel releasing 20 µg/day) lasts 5 YEARS; Multiload-375 lasts 5 years.**

**UNDERSTAND:** The **COPPER IUCD works CHEMICALLY, not mechanically** — copper ions are **directly spermicidal and toxic to ova**, and they induce a sterile inflammatory endometrial reaction. So effectiveness depends on **the surface area of copper exposed**, which is why devices are named by their copper surface (375, 380 mm²) and why fragmentation matters enough to justify a silver core. **The LNG-IUS works differently — thickening cervical mucus and atrophying the endometrium** — which is why it **REDUCES** menstrual loss while the copper device **INCREASES** it.
...
### 143. DMPA (Depot Medroxyprogesterone Acetate)
...
- **Mechanism: suppression of the LH surge → ANOVULATION (primary), plus thick cervical mucus and endometrial atrophy.** Typical-use failure ~**3–4%** (perfect use <1%).
- **Advantages: NO OESTROGEN — safe in smokers over 35, hypertension, migraine with aura, previous VTE; usable while BREASTFEEDING and from immediately postpartum; reduces dysmenorrhoea, menorrhagia, endometriosis pain and SICKLE CELL CRISES; protects against ENDOMETRIAL CANCER and PID; and is NOT affected by enzyme-inducing antiepileptics — a key reason it is chosen in EPILEPSY (it may even raise the seizure threshold).**
- **Disadvantages: DELAYED RETURN OF FERTILITY (median 9–10 months after the last injection — a poor choice for a woman planning pregnancy soon), weight gain, mood change, and REVERSIBLE LOSS OF BONE MINERAL DENSITY (a black-box warning — of most concern in adolescents and beyond 2 years of use).**
...
- **POMEROY: a loop of mid-tube ligated with PLAIN CATGUT (deliberately absorbable, so the ends separate) and excised — commonest, and the standard in minilaparotomy and postpartum sterilisation. MODIFIED POMEROY (PARKLAND): the two ends ligated separately without a loop. UCHIDA: serosa stripped, tube excised, proximal stump buried in the BROAD LIGAMENT. IRVING: proximal end buried in the MYOMETRIUM, distal in the broad ligament. KROENER: ampulla ligated and the infundibulum with fimbriae resected — high failure and irreversible. MADLENER: obsolete, high failure.**
...
**UNDERSTAND:** Male hormonal contraception is difficult because **spermatogenesis takes ~74 days and requires suppression of intratesticular testosterone to near zero**, which simultaneously abolishes libido and secondary sexual function unless testosterone is replaced. Gossypol was attractive precisely because it acts **directly on the seminiferous epithelium and Sertoli cells rather than through the hypothalamic–pituitary axis** — but its potassium-channel and mitochondrial toxicity proved unacceptable.
...
- **Postpartum choices: PROGESTOGEN-ONLY methods (POP, DMPA, implants) and the LNG-IUS are safe in breastfeeding and can be started early. COMBINED oestrogen-containing pills are AVOIDED for the first 6 WEEKS (VTE risk) and generally until 6 months in breastfeeding women (they reduce milk supply). PPIUCD within 48 HOURS of delivery or after 6 weeks.**
- **Once well past the puerperium (e.g. 18 months, child on complementary feeds), a COC is an excellent choice — and if she has HEAVY IRREGULAR BLEEDING it treats that too.** By then both objections have lapsed: **thromboembolic risk is confined to the first 6 weeks, and lactation suppression matters only while milk is the sole nutrition.**
- **Why the alternatives fail in that scenario: a COPPER-T worsens menorrhagia and dysmenorrhoea; DMPA and norethisterone enanthate cause breakthrough bleeding — the exact symptom she has.** (**The LNG-IUS is the strong alternative**, being first-line for menorrhagia.)
...
### 147. Müllerian Duct Anomalies (AFS Classification)

**PEARL:** **AFS/ASRM classes: I — MÜLLERIAN AGENESIS/hypoplasia (MRKH). II — UNICORNUATE. III — DIDELPHYS. IV — BICORNUATE. V — SEPTATE. VI — ARCUATE (a flat-topped fundus with loss of the fundal bulge — the mildest, essentially a normal variant). VII — DES-RELATED (T-shaped uterus).** **The SEPTATE uterus is the commonest anomaly, has the WORST reproductive outcome, and is the ONE with an effective low-risk treatment — TRANSCERVICAL HYSTEROSCOPIC RESECTION.**

**UNDERSTAND:** The classification follows **embryology in sequence: failure of DEVELOPMENT (I, II), failure of FUSION of the two Müllerian ducts (III, IV), and failure of RESORPTION of the intervening septum (V, VI).** Hence the crucial surgical distinction: **SEPTATE (a normal external fundal contour with an internal septum — a RESORPTION defect, correctable hysteroscopically) versus BICORNUATE (an INDENTED external fundal contour — a FUSION defect, requiring abdominal metroplasty if anything).** And hysteroscopy is preferred because the abdominal metroplasties (**Jones, Tompkins, Strassmann**) all **incise the uterine wall**, leaving a scar that risks **rupture in labour and mandates caesarean**; hysteroscopy divides avascular fibrous tissue **from inside the cavity without breaching the myometrium**.

**MUST KNOW:**

- **The septum is poorly vascularised fibrous tissue that cannot support implantation — hence RECURRENT FIRST-TRIMESTER MISCARRIAGE.**
- **Distinguishing septate from bicornuate: on HSG the INTERCORNUAL ANGLE — <75° = SEPTATE, >105° = BICORNUATE — but HSG CANNOT SEE THE FUNDAL CONTOUR, so MRI (or 3D ultrasound) is the investigation of choice.** A **fundal cleft >1 cm** means bicornuate.
- **UNICORNUATE uterus with a NON-COMMUNICATING RUDIMENTARY HORN causes CYCLICAL PAIN, HAEMATOMETRA and a risk of ECTOPIC PREGNANCY IN THE HORN WITH RUPTURE — excise the horn.**
...
**REMEMBER:** *Development, fusion, resorption — and only the septum is worth resecting. Narrow angle = septum (cut it); wide angle plus notched fundus = bicornuate (leave it).*
...
- **IMPERFORATE HYMEN: primary amenorrhoea, cyclical pain, a lower abdominal mass, sometimes urinary retention, and a TENSE BLUISH BULGING MEMBRANE at the introitus — treat by CRUCIATE INCISION. TRANSVERSE VAGINAL SEPTUM: identical, but NO bulging membrane and a shorter vagina — requires surgical excision, with a higher risk of stenosis and recurrence.**
- **OHVIRA (HERLYN–WERNER–WUNDERLICH): uterus DIDELPHYS + OBSTRUCTED HEMIVAGINA + IPSILATERAL RENAL AGENESIS (almost always the same side). Presents WITHIN MONTHS OF MENARCHE with normal periods, escalating analgesia-resistant dysmenorrhoea, a paravaginal mass, sometimes foul discharge, and later endometriosis/haematosalpinx. MRI is the gold standard plus renal ultrasound; treatment is VAGINAL SEPTUM RESECTION/MARSUPIALISATION — simple and curative.**
- **Endometriosis pain correlates with the DEPTH OF INFILTRATION (lesions >5 mm) rather than with stage or number of sites** — deep infiltrating disease of the uterosacrals and rectovaginal septum causes the worst dyspareunia and dyschezia.
- **First-line imaging for suspected endometriosis is TRANSVAGINAL ULTRASOUND (good for endometriomas and deep disease); laparoscopy remains the gold standard but is no longer the first step.**

**EXAM CONNECTION:** Transverse vaginal septum with dysmenorrhoea → **endometriosis**. **Normal menses plus escalating pain → OHVIRA**; if the stem says amenorrhoea, switch to imperforate hymen/septum/agenesis.

**REMEMBER:** *Block the outflow and the blood goes backwards through the tubes. Periods present but pain worsening — one side is blocked, and that kidney is missing.*
...
### 149. 46,XY Disorders of Sex Development
...
- **Two features decide everything: IS THE UTERUS PRESENT (did AMH act?) and DO BREASTS DEVELOP (is there oestrogen?).**
- **The 5α-reductase vs CAIS one-liner: 5α-reductase deficiency VIRILISES at puberty and has SOME pubic hair; androgen insensitivity does NEITHER but has BETTER breasts.** 5α-reductase deficiency shows a **raised testosterone:DHT ratio**.
- **CAIS: testes intra-abdominal or inguinal — REMOVE AFTER PUBERTY** (lower tumour risk, and it allows spontaneous feminisation). **SWYER: GONADECTOMY IS MANDATORY** — dysgenetic gonads with a Y chromosome carry a high risk of **gonadoblastoma/dysgerminoma**; treat with cyclical oestrogen–progestogen, and pregnancy is possible with **donor oocytes**. Swyer shows **FSH >40 mIU/mL with oestradiol <25 pg/mL**.
...
- **Any DSD needs a multidisciplinary team, karyotype, pelvic imaging and a hormonal profile (testosterone, DHT, 17-OHP, AMH); sex of rearing is a considered decision and irreversible surgery is deferred.**

**EXAM CONNECTION:** 46,XY + male testosterone + virilisation at puberty → **5α-reductase deficiency**.

**REMEMBER:** *Testosterone builds the inside, DHT builds the outside. Uterus present means AMH never worked; breasts present means oestrogen did.*
...
- **The two testicular products and their targets: SERTOLI cells make AMH, which REGRESSES the Müllerian ducts (uterus, tubes, upper vagina); LEYDIG cells make TESTOSTERONE, which maintains the WOLFFIAN ducts (epididymis, vas, seminal vesicles) and — after 5α-reductase conversion to DHT — masculinises the EXTERNAL genitalia and prostate.**
- **Timing rules everything: external genital masculinisation occurs at 8–12 weeks, so ANDROGEN EXCESS BEFORE 12 WEEKS (CAH) causes LABIOSCROTAL FUSION, while exposure after 12 weeks causes only clitoromegaly.**
...
### 151. Rectal Examination in Gynaecology

**PEARL:** Rectal examination is indicated in **CHILDREN and VIRGINS, when vaginal examination is painful or impossible, in VAGINAL AGENESIS/atresia, to assess PARAMETRIAL and uterosacral involvement in CARCINOMA CERVIX (the base of the broad ligament and the uterosacral ligaments can ONLY be felt rectally), to corroborate pouch-of-Douglas findings, and to DIFFERENTIATE RECTOCELE FROM ENTEROCELE.** **It has NO role in STAGING OVARIAN MALIGNANCY** (which is staged SURGICALLY).
...
- **Rectovaginal examination distinguishes RECTOCELE (the finger enters the bulge from the rectum) from ENTEROCELE (bowel felt between the rectal and vaginal fingers, above the rectocele)** — the classic bedside discrimination.
...
### 152. Endometrial Sampling — Pipelle, D&C and Hysteroscopy
...
**PEARL:** A **FLUID DEFICIT of ~2000 mL during operative hysteroscopy causes FLUID OVERLOAD → PULMONARY OEDEMA** (and with **HYPOTONIC media, DILUTIONAL HYPONATRAEMIA with cerebral oedema**). **Maximum permitted deficits: HYPOTONIC fluid (glycine, sorbitol) 1000 mL in the healthy, 750 mL in the elderly or comorbid; ISOTONIC NORMAL SALINE 2500 mL in the healthy, 750–1000 mL with cardiovascular disease.**

**UNDERSTAND:** Distension media are absorbed through **open venous sinuses in the myometrium**, and absorption rises with **intrauterine pressure, operating time and the depth of myometrial resection** — which is why submucous fibroid resection is the highest-risk procedure. The **medium determines the syndrome**: **isotonic saline causes VOLUME overload alone** (used with bipolar/mechanical instruments), whereas **glycine (needed for monopolar energy) causes volume overload PLUS HYPONATRAEMIA and, through metabolism to ammonia, encephalopathy and visual disturbance** — the gynaecological equivalent of TUR syndrome.

**MUST KNOW:**

- **Management: STOP THE PROCEDURE, check SERUM ELECTROLYTES, give FUROSEMIDE and oxygen for volume overload; for SYMPTOMATIC HYPONATRAEMIA give 3% HYPERTONIC SALINE in intensive care, correcting SLOWLY to avoid OSMOTIC DEMYELINATION.** Asymptomatic mild hyponatraemia → fluid restriction and monitoring.
- **Prevention: an AUTOMATED FLUID MANAGEMENT SYSTEM with continuous deficit monitoring; keep intrauterine pressure at the MINIMUM that gives a view (ideally below mean arterial pressure); limit operating time; use BIPOLAR energy with SALINE; and pre-treat large fibroids with a GnRH analogue.**
- **Other hysteroscopic complications: UTERINE PERFORATION (the commonest — highest during cervical dilatation), bleeding, infection, gas embolism (with CO₂ distension), cervical laceration.**
...
### 154. Female Genital Mutilation

**PEARL:** **WHO TYPE III = INFIBULATION** — partial or total excision of the labia minora and/or majora, with or without clitoridectomy, followed by **FUSION/NARROWING of the vaginal opening.** **Type I — prepuce excision ± clitoridectomy. Type II — clitoral excision ± partial/total labia minora excision. Type IV — all other harmful procedures (pricking, piercing, incising, scraping, cauterisation, corrosive substances).**

**UNDERSTAND:** Type III is by far the most damaging because it does not merely remove tissue but **creates a physical seal**, so its complications are **obstructive as well as ablative**: **haematocolpos, urinary retention, recurrent infection, and obstetrically an obstructed second stage requiring DEFIBULATION.** Grading is therefore not academic — it predicts exactly what will be needed in labour.
...
**PEARL:** Clinical audit in obstetrics is done **after analysing outcomes**, to standardise care and drive continuous evidence-based improvement.
...
*Footnotes below support the guideline-dependent points flagged in the pearls above. Where Indian PG exams still test an older version (FIGO 2009 endometrial staging, the 4 cm partograph), both the examined version and the current one are given.*

[^1]: **WHO guideline on haemoglobin cutoffs to define anaemia in individuals and populations (2024)** — trimester-specific cut-offs in pregnancy: <11.0 g/dL in the first and third trimesters, <10.5 g/dL in the second, with the severity bands shifting correspondingly in the second trimester, plus new adjustments for altitude and smoking. <https://www.who.int/publications/i/item/9789240088542>

[^2]: **Chronic Hypertension and Pregnancy (CHAP) trial** and the **ACOG Practice Advisory, “Clinical Guidance for the Integration of the Findings of the CHAP Study” (April 2022)**, endorsed by SMFM — treat chronic hypertension in pregnancy from a threshold of 140/90 mmHg instead of 160/110, with no increase in birthweight below the 10th centile. <https://www.acog.org/clinical/clinical-guidance/practice-advisory/articles/2022/04/clinical-guidance-for-the-integration-of-the-findings-of-the-chronic-hypertension-and-pregnancy-chap-study>

[^3]: **WHO recommendations on the prevention, diagnosis and treatment of postpartum haemorrhage (2025)**, aligned with FIGO and ICM — objective blood-loss measurement for diagnosis and the E-MOTIVE bundle (uterine massage, oxytocic drugs, tranexamic acid, IV fluids, examination, escalation) delivered simultaneously and immediately, with tranexamic acid within 3 hours as first-line treatment. <https://www.thelancet.com/journals/langlo/article/PIIS2214-109X(25)00404-8/fulltext>

[^4]: **Berek JS et al., “FIGO staging of endometrial cancer: 2023”**, *International Journal of Gynecology & Obstetrics* — incorporation of histological type, tumour grade, substantial lymphovascular space invasion and molecular classification (POLEmut, MMRd, NSMP, p53abn) into the stage, with POLEmut downstaging and p53abn upstaging early disease. <https://obgyn.onlinelibrary.wiley.com/doi/10.1002/ijgo.14923>
